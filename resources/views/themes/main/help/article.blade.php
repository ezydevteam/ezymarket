@extends('themes.main.help.layout')
    ...
    <div class="row g-5">
        <div class="col-12 col-xl-8">
            <div class="article-header mb-4">
                ...
                <div class="row row-cols-auto g-2 text-muted small">
                    <div class="col">
                        <i class="fa-regular fa-calendar me-2"></i>{{ $article->created_at->format('M d, Y') }}
                    </div>
                </div>
            </div>
            <div class="article-body">
                <div class="article-content">{!! $article->content !!}</div>
                <div class="card-v border text-center mt-4 p-3">
        ...
        <div class="col-xl-4 d-none d-xl-block">
            ...
            <nav class="support-sidebar-links position-sticky card-v border p-2">
                <div class="px-2 pt-2">
                    <h5 class="mb-3">{{ translate('Related Topics') }}</h5>
                </div>
                <nav class="nav nav-pills flex-column">
                    @foreach ($relatedArticles as $relatedArticle)
                        <a class="nav-link" href="{{ $relatedArticle->view_link }}"><i
