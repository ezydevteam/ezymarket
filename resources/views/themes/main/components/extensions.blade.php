...
@if (getExtension('google_analytics') && getExtension('google_analytics')->is_active)
    <script async
        src="https://www.googletagmanager.com/gtag/js?id={{ getExtension('google_analytics')->credentials->measurement_id }}">
    </script>
    <script>
        ...
        gtag("js", new Date());
        gtag("config", "{{ getExtension('google_analytics')->credentials->measurement_id }}");
    </script>
@endif

@if (getExtension('tawk_to') && getExtension('tawk_to')->is_active)
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/{{ getExtension("tawk_to")->credentials->api_key }}';
            s1.charset = 'UTF-8';
