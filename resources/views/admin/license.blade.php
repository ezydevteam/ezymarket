...
@section('content')
    <div class="card">
        <div class="card-body p-4">
            ...
            <p class="text-muted">
                {{ translate('You can use this tool to verify license codes from buyers and Sellers.') }}
            </p>
            <form action="{{ route('admin.license-verification.check') }}" method="POST">
                @csrf
                <div class="mb-3">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item p-4">
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="{{ route('admin.products.show', $purchase->product->id) }}" target="_blank"
                                class="text-dark">
                ...
                <li class="list-group-item p-4">
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-auto">
                            @if($purchase->seller)
                                <a href="{{ route('admin.roles.users.edit', $purchase->seller->id) }}" target="_blank"
                                    class="text-dark">
                ...
                <li class="list-group-item p-4">
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="{{ route('admin.roles.users.edit', $purchase->user->id) }}" target="_blank"
                                class="text-dark">
