<div class="row g-3 mb-4">
    @php
        $counterItems = [
            [
                'title' => translate('Total Purchases'),
                'count' => numberFormat($counters['total']['total']),
                'percent' => $counters['total']['percent'],
                'icon' => 'bi-bag-check',
                'color' => 'primary',
                'link' => route('admin.records.purchases.index'),
            ...
            [
                ...
                'color' => 'success',
                'link' => route('admin.records.purchases.index', ['status' => \App\Enums\PurchaseStatus::ACTIVE->value]),
                'comparisonText' => translate('vs last week'),
            ...
            [
                ...
                'color' => 'warning',
                'link' => route('admin.records.purchases.index', ['status' => \App\Enums\PurchaseStatus::REFUNDED->value]),
                'comparisonText' => translate('vs last week'),
            ...
            [
                ...
                'icon' => 'bi-x-circle',
                'color' => 'danger',
                'link' => route('admin.records.purchases.index', ['status' => \App\Enums\PurchaseStatus::CANCELLED->value]),
                'comparisonText' => translate('vs last week'),
