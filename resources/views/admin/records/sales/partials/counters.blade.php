    ...
    @php
        $counterItems = [
            [
                ...
                'icon' => 'bi-cart-check',
                'color' => 'primary',
                'link' => route('admin.records.sales.index'),
            ...
            [
                ...
                'color' => 'success',
                'link' => route('admin.records.sales.index', ['status' => 'active']),
            ...
            [
                ...
                'color' => 'warning',
                'link' => route('admin.records.sales.index', ['status' => 'refunded']),
            ...
            [
                ...
                'icon' => 'bi-x-circle',
                'color' => 'danger',
                'link' => route('admin.records.sales.index', ['status' => 'cancelled']),
