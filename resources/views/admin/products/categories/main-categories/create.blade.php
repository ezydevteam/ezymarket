...
@section('title', translate('Create New Category'))
@section('header_title', translate('Create New Category'))
@section('description', translate('Create a new main category for products'))
@section('back', route('admin.products.categories.index'))
@section('container', 'container-max-xxl')
@section('header_actions')
<button type="submit" form="createCategoryForm" class="btn btn-md btn-primary rounded-pill"><i
        class="bi bi-check2-circle me-2"></i>{{ translate('Create Category') }}</button>
@endsection
@section('content')
<form id="createCategoryForm" class="ajax-form" action="{{ route('admin.products.categories.store') }}" method="POST">
    @csrf
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="card mb-3">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="name" id="create_slug" class="form-control form-control-md"
                                placeholder="{{ translate('Enter category name') }}" value="{{ old('name') }}"
                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                ...
                                <select name="preview_type" class="form-select form-select-md selectpicker"
                                    ...
                                    $label)
                                    <option value="{{ $value }}" {{ old('preview_type')==$value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group">
                                    <input type="number" name="preview_file_size" class="form-control form-control-md"
                                        placeholder="e.g. 5" value="{{ old('preview_file_size') }}" step="0.01" min="0">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    <input type="number" name="gallery_images_count"
                                        ...
                                        value="{{ old('gallery_images_count') }}" step="1" min="1">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group">
                                    <input type="number" name="main_file_size" class="form-control form-control-md"
                                        placeholder="e.g. 100" value="{{ old('main_file_size') }}" step="0.01" min="0">
                                    <span class="input-group-text">{{ translate('MB') }}</span>
                                </div>
                                <div class="form-text">
