<div class="tab-pane fade" id="products-item" role="tabpanel" aria-labelledby="products-item-tab">
    <div class="mb-4">
        <h2 class="mb-3">{{ translate('Get An product Details') }}</h2>
        <p>
            {{ translate('Retrieves details of a specific product based on the provided product ID and API key.') }}
        </p>
    ...
    <div class="code mb-3">
        ...
        <code>
            <pre class="mb-0"><div class="method get">{{ translate('GET') }}</div><div class="endpoint copy-data">{{ route('api.products.product') }}</div></pre>
        </code>
    </div>
    ...
    <ul>
        ...
        <li><strong>product_id</strong>: {{ translate('The ID of the product to retrieve') }}
            <code>({{ translate('required') }})</code>
        </li>
    </ul>
