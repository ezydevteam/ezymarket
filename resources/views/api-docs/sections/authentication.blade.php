    ...
    <div class="mb-4">
        ...
        <div class="card mb-4">
            <div class="card-body p-4">
                <h4>{{ translate('Navigate to Portal Settings') }}</h4>
                <p class="card-text">
                    {{ translate('The user should first log in to their account on the platform. Then, they can navigate to the "Settings" section of their portal.') }}
                </p>
            </div>
        </div>
        <div class="card mb-4">
            <div class="card-body p-4">
                ...
                <p class="card-text">
                    {{ translate('Within the Portal Settings, the user should look for a section specifically labeled "API Key" or "API Access."') }}
                </p>
            </div>
        </div>
        <div class="card mb-4">
