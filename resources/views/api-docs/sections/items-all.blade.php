<div class="tab-pane fade" id="products-all" role="tabpanel" aria-labelledby="products-all-tab">
    <div class="mb-4">
        <h2 class="mb-3">{{ translate('Get All products') }}</h2>
        <p>
    ...
    <div class="code mb-3">
        ...
        <code>
            <pre class="mb-0"><div class="method get">{{ translate('GET') }}</div><div class="endpoint copy-data">{{ route('api.products.all') }}</div></pre>
        </code>
    </div>
