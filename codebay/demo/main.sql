...
--
-- Host: localhost:3306
-- Generation Time: Oct 04, 2025 at 11:16 PM
...
INSERT INTO `addons` (`id`, `name`, `alias`, `version`, `thumbnail`, `path`, `action`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Multi Currency', 'multi_currency', '1.0', 'images/addons/multi-currency/thumbnail.png', 'addons/multi-currency', 'financial/currencies', 0, '2025-10-04 07:09:03', '2025-10-04 07:09:03');
...
INSERT INTO `admins` (`id`, `firstname`, `lastname`, `username`, `email`, `avatar`, `password`, `google2fa_status`, `google2fa_secret`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, NULL, NULL, 'admin', 'admin@djd.com', NULL, '$2y$10$AMtrzK.35Zur7l4j35m.6Ohvl/TElnfHhT63HgdIW2fWL9IkvYEM.', 0, NULL, '84lB9sfFwjq4rx2USYBK9lWc8hWJdjXNp0qAF0tRl7IbJY8WzEnhYsrK1FBg', '2025-10-04 06:36:31', '2025-10-04 06:36:31');
...
(5, 'product_page_top', 'product Page (Top)', NULL, NULL, 0, '2024-04-16 22:20:58', '2024-04-16 17:30:56'),
(6, 'product_page_center', 'product Page (Center)', NULL, NULL, 0, '2024-04-16 22:20:58', '2024-04-16 17:30:56'),
(7, 'product_page_bottom', 'product Page (Bottom)', NULL, NULL, 0, '2024-04-16 22:20:58', '2024-04-16 17:30:56'),
...
--
-- Table structure for table `seller_taxes`
--

CREATE TABLE `seller_taxes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
...
CREATE TABLE `badges` (
  ...
  `membership_years` bigint(20) DEFAULT NULL,
...
(2, 'Exclusive Seller', 'exclusive_seller', 'He sells exclusive products', 'images/badges/Rvd9rlxmiXiv9rR_1704495444.svg', NULL, NULL, NULL, 1, '2024-01-05 17:57:24', '2024-01-05 17:57:24'),
(3, 'Trend Master', 'trend_master', 'He had an product that was trending', 'images/badges/Npo0RQSbyvl4bDs_1704495462.svg', NULL, NULL, NULL, 1, '2024-01-05 17:57:42', '2024-03-05 17:16:12'),
(4, 'Featured Seller', 'featured_seller', 'He had been a featured seller', 'images/badges/v8pT8eGx7xaNvvZ_1718672138.png', NULL, NULL, NULL, 1, '2024-06-17 17:46:26', '2024-06-18 15:10:59'),
(5, 'Featured product', 'featured_product', 'He had a featured product', 'images/badges/yhDbZKZyQ7bSoVj_1718672600.png', NULL, NULL, NULL, 1, '2024-06-17 18:03:20', '2024-06-18 15:11:16'),
...
(7, 'Discount Master', 'discount_master', 'Had one or more discounted products', 'images/badges/bD2nnZB4AiO5kpl_1710699376.svg', NULL, NULL, NULL, 1, '2024-03-17 18:16:16', '2024-03-17 18:16:16'),
(8, 'Premiumer', 'premiumer', 'Had an product in premium subscription', 'images/badges/nIUU3A7yQwsDDgW_1726082927.png', NULL, NULL, NULL, 1, '2024-01-05 17:56:22', '2024-09-11 18:28:47'),
...
(10, 'Team Member', 'team_member', 'A member of the EasyMarket Team', 'images/badges/7ZGgVZHjitn9rfG_1713747386.png', NULL, NULL, NULL, 0, '2024-01-05 18:00:02', '2024-04-21 17:56:26'),
...
(23, 'New Seller', 'seller_level', NULL, 'images/badges/oYY2O5SKEQPbwDk_1713448047.svg', NULL, 1, NULL, 0, '2024-01-05 18:46:46', '2024-04-18 06:49:22'),
(24, 'Seller level 1', 'seller_level', 'He made $100 or more in sales', 'images/badges/VrF5shysCjcJ4is_1704498406.svg', NULL, 2, NULL, 0, '2024-01-05 18:46:46', '2024-04-21 18:08:12'),
(25, 'Seller level 2', 'seller_level', 'He made $1,000 or more in sales', 'images/badges/2i30DFThWdX6gpC_1704498444.svg', NULL, 3, NULL, 0, '2024-01-05 18:47:24', '2024-04-21 18:08:22'),
(26, 'Seller level 3', 'seller_level', 'He made $5,000 or more in sales', 'images/badges/kY1rtNWKDdvg13T_1704498476.svg', NULL, 4, NULL, 0, '2024-01-05 18:47:56', '2024-04-21 18:08:25'),
(27, 'Seller level 4', 'seller_level', 'He made $10,000 or more in sales', 'images/badges/9Kkep2QwIzke4jk_1704498512.svg', NULL, 5, NULL, 0, '2024-01-05 18:48:32', '2024-04-21 18:08:28'),
(28, 'Seller level 5', 'seller_level', 'He made $25,000 or more in sales', 'images/badges/5OiihmkAAf9gz1P_1704498535.svg', NULL, 6, NULL, 0, '2024-01-05 18:48:55', '2024-04-21 18:08:32'),
(29, 'Seller level 6', 'seller_level', 'He made $45,000 or more in sales', 'images/badges/qoh5TyETEBJvRiQ_1704498561.svg', NULL, 7, NULL, 0, '2024-01-05 18:49:21', '2024-04-21 18:08:35'),
(30, 'Seller level 7', 'seller_level', 'He made $75,000 or more in sales', 'images/badges/kpCkIEG5nGLLXGc_1704498582.svg', NULL, 8, NULL, 0, '2024-01-05 18:49:42', '2024-04-21 18:08:38'),
(31, 'Seller level 8', 'seller_level', 'He made $250,000 or more in sales', 'images/badges/lBvmt2Iz4RI2sRM_1704498609.svg', NULL, 9, NULL, 0, '2024-01-05 18:50:09', '2024-04-21 18:08:42'),
(32, 'Seller level 9', 'seller_level', 'He made $500,000 or more in sales', 'images/badges/GtrlNV3clMHCkaF_1704498640.svg', NULL, 10, NULL, 0, '2024-01-05 18:50:40', '2024-04-21 18:08:46'),
(33, 'Top Rated Seller', 'seller_level', 'He made $1,000,000 or more in sales', 'images/badges/Llkq7gzoAfD6WaY_1704498679.svg', NULL, 11, NULL, 0, '2024-01-05 18:51:19', '2024-04-21 18:08:50'),
...
--
-- Table structure for table `bottom_nav_menus`
--

CREATE TABLE `bottom_nav_menus` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Dumping data for table `bottom_nav_menus`
--

INSERT INTO `bottom_nav_menus` (`id`, `name`, `slug`, `menu_type`, `parent_id`, `order`, `custom_class`, `custom_html`, `created_at`, `updated_at`) VALUES
(2, 'Code', '/', 1, NULL, 2, NULL, NULL, '2023-12-01 13:01:53', '2023-12-15 16:17:09'),
(3, 'JavaScript', '/categories/code/javascript', 1, 2, 1, NULL, NULL, '2023-12-01 13:02:10', '2023-12-15 16:17:25'),
(4, 'PHP Scripts', '/categories/code/php-scripts', 1, 2, 2, NULL, NULL, '2023-12-01 13:30:23', '2023-12-15 16:17:34'),
(5, 'CSS', '/categories/code/css', 1, 2, 3, NULL, NULL, '2023-12-01 13:30:48', '2023-12-15 16:17:41'),
(6, 'HTML5', '/categories/code/html5', 1, 2, 4, NULL, NULL, '2023-12-01 13:31:00', '2023-12-15 16:17:53'),
(7, '.NET', '/categories/code/net', 1, 2, 5, NULL, NULL, '2023-12-01 13:31:18', '2023-12-15 16:17:56'),
(8, 'Themes', '/', 1, NULL, 1, NULL, NULL, '2023-12-01 13:32:06', '2023-12-14 16:11:23'),
(9, 'WordPress', '/categories/themes/wordpress', 1, 8, 1, NULL, NULL, '2023-12-01 13:33:48', '2023-12-15 12:17:57'),
(10, 'HTML/CSS', '/categories/themes/html-css', 1, 8, 2, NULL, NULL, '2023-12-01 13:34:06', '2024-05-03 21:06:25'),
(11, 'Shopify', '/categories/themes/shopify', 1, 8, 4, NULL, NULL, '2023-12-02 15:00:52', '2023-12-15 12:18:16'),
(12, 'Bootstrap', '/categories/themes/bootstrap', 1, 8, 3, NULL, NULL, '2023-12-02 15:01:16', '2023-12-15 12:18:07'),
(13, 'Blogger', '/categories/themes/blogger', 1, 8, 5, NULL, NULL, '2023-12-02 15:01:35', '2023-12-15 12:18:27'),
(14, 'Graphics', '/', 1, NULL, 6, NULL, NULL, '2023-12-02 15:02:16', '2024-09-05 10:13:43'),
(15, 'Illustrations', '/categories/graphics/illustrations', 1, 14, 4, NULL, NULL, '2023-12-02 15:02:31', '2023-12-15 12:22:19'),
(16, 'Icons', '/categories/graphics/icons', 1, 14, 1, NULL, NULL, '2023-12-02 15:02:43', '2023-12-15 12:21:47'),
(17, 'Objects', '/categories/graphics/objects', 1, 14, 2, NULL, NULL, '2023-12-02 15:03:06', '2023-12-15 12:21:59'),
(18, 'Patterns', '/categories/graphics/patterns', 1, 14, 3, NULL, NULL, '2023-12-02 15:03:17', '2023-12-15 12:22:10'),
(19, 'Web Elements', '/categories/graphics/web-elements', 1, 14, 5, NULL, NULL, '2023-12-02 15:03:31', '2023-12-15 12:22:31'),
(20, 'Mobile Apps', '/', 1, NULL, 7, NULL, NULL, '2023-12-02 15:04:03', '2024-09-05 10:13:43'),
(21, 'Android', '/categories/mobile-apps/android', 1, 20, 1, NULL, NULL, '2023-12-02 15:04:22', '2023-12-15 12:22:51'),
(22, 'IOS', '/categories/mobile-apps/ios', 1, 20, 2, NULL, NULL, '2023-12-02 15:04:27', '2023-12-15 12:22:59'),
(23, 'Native Web', '/categories/mobile-apps/native-web', 1, 20, 3, NULL, NULL, '2023-12-02 15:04:41', '2023-12-15 12:23:08'),
(24, 'Unity', '/categories/mobile-apps/unity', 1, 20, 4, NULL, NULL, '2023-12-02 15:04:59', '2023-12-15 12:23:19'),
(25, 'Plugins', '/', 1, NULL, 5, NULL, NULL, '2023-12-02 15:06:09', '2024-09-05 10:13:43'),
(26, 'WordPress Plugins', '/categories/plugins/wordpress-plugins', 1, 25, 1, NULL, NULL, '2023-12-02 15:06:29', '2023-12-15 12:20:24'),
(27, 'Magento Extensions', '/categories/plugins/magento-extensions', 1, 25, 2, NULL, NULL, '2023-12-02 15:06:52', '2023-12-15 12:20:33'),
(28, 'OpenCart', '/categories/plugins/opencart', 1, 25, 3, NULL, NULL, '2023-12-02 15:07:10', '2023-12-15 12:20:46'),
(29, 'Joomla', '/categories/plugins/joomla', 1, 25, 4, NULL, NULL, '2023-12-02 15:07:44', '2023-12-15 12:20:58'),
(30, 'Drupal', '/categories/plugins/drupal', 1, 25, 5, NULL, NULL, '2023-12-02 15:08:01', '2023-12-15 12:21:09'),
(31, 'Video', '/categories/video', 1, NULL, 3, NULL, NULL, '2024-09-05 10:09:47', '2024-09-05 10:13:35'),
(32, 'Effects', '/categories/video/effects', 1, 31, 1, NULL, NULL, '2024-09-05 10:10:29', '2024-09-05 10:12:56'),
(33, 'Graphics', '/categories/video/graphics', 1, 31, 2, NULL, NULL, '2024-09-05 10:10:42', '2024-09-05 10:12:41'),
(34, 'Audio', '/categories/audio', 1, NULL, 4, NULL, NULL, '2024-09-05 10:10:59', '2024-09-05 10:13:43'),
(35, 'Music', '/categories/audio/music', 1, 34, 1, NULL, NULL, '2024-09-05 10:11:53', '2024-09-05 10:11:55'),
(36, 'Sound Effects', '/categories/audio/sound-effects', 1, 34, 2, NULL, NULL, '2024-09-05 10:12:17', '2024-09-05 10:12:20');
...
CREATE TABLE `cart_products` (
  ...
  `license_type` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1:Regular 2:Extended',
  `quantity` int(10) UNSIGNED NOT NULL DEFAULT 1,
  `support_period_id` bigint(20) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `categories` (
  ...
  `thumbnail_width` bigint(20) UNSIGNED NOT NULL DEFAULT 120,
  `thumbnail_height` bigint(20) UNSIGNED NOT NULL DEFAULT 120,
  `preview_image_width` bigint(20) UNSIGNED DEFAULT NULL,
  `preview_image_height` bigint(20) UNSIGNED DEFAULT NULL,
  `maximum_screenshots` bigint(20) UNSIGNED DEFAULT NULL,
  `main_file_types` varchar(255) NOT NULL DEFAULT 'zip,rar,pdf',
  `max_preview_file_size` bigint(20) UNSIGNED NOT NULL DEFAULT 10485760,
  `views` bigint(20) NOT NULL DEFAULT 0,
...
CREATE TABLE `category_options` (
  ...
  `type` tinyint(4) NOT NULL COMMENT '1:Single Select 2:Multiple Select',
  `name` varchar(255) NOT NULL,
...
--
-- Table structure for table `category_editor`
--

CREATE TABLE `category_editor` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `category_id` bigint(20) UNSIGNED NOT NULL,
...
CREATE TABLE `currencies` (
  ...
  `position` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1:Before price 2:After price',
...
INSERT INTO `currencies` (`id`, `code`, `symbol`, `position`, `rate`, `icon`, `sort_id`, `created_at`, `updated_at`) VALUES
(1, 'USD', '$', 1, 1.000000000, 'images/currencies/usd.png', 1, '2024-12-04 11:46:58', '2024-12-04 11:46:58');
...
INSERT INTO `footer_menus` (`id`, `name`, `slug`, `menu_type`, `parent_id`, `order`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `home_sections` (
  ...
  `cache_expiry_time` int(10) UNSIGNED DEFAULT NULL,
...
INSERT INTO `home_sections` (`id`, `name`, `alias`, `description`, `products_number`, `cache_expiry_time`, `status`, `sort_id`) VALUES
(1, 'Explore Categories', 'categories', NULL, NULL, 10, 1, 1),
(2, 'Trending products', 'trending_products', NULL, 4, 1440, 1, 2),
(3, 'Best Selling products', 'best_selling_products', NULL, 4, 1440, 1, 3),
(4, 'Sale products', 'sale_products', NULL, 4, 1440, 1, 4),
(5, 'Free products', 'free_products', NULL, 4, 1440, 1, 5),
(6, 'Our Latest products', 'latest_products', 'Explore our latest digital offerings, including PHP scripts, templates, and plugins. Stay updated with our newest arrivals, designed to enhance your web projects with cutting-edge functionality and innovation.', 8, 60, 1, 8),
(7, 'FAQ\'s', 'faqs', 'Got questions? We\'ve got answers. Delve into our Frequently Asked Questions (FAQs) section to find comprehensive information about our products, services, and more.', NULL, 30, 1, 10),
...
(11, 'Featured Seller', 'featured_seller', NULL, 3, 1440, 1, 7),
(12, 'Featured products', 'featured_products', 'Each week, our team carefully selects the finest new themes, scripts, and plugins from our extensive library.', 4, 1440, 1, 9),
(13, 'Premium products', 'premium_products', '', 4, 1440, 1, 6);
...
CREATE TABLE `products` (
  ...
  `support_instructions` text DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1:Pending 2:Soft rejected 3:Resubmitted 4:Approved 5:Hard Rejected 6:Deleted',
  ...
  `total_reviews` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
  `avg_reviews` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
  ...
  `current_month_views` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
  `free_downloads` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `regular_price_label` varchar(255) DEFAULT NULL,
  `extended_price_label` varchar(255) DEFAULT NULL,
  `regular_extra_features` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`regular_extra_features`)),
  `extended_extra_features` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`extended_extra_features`)),
  `has_custom_services` tinyint(1) NOT NULL DEFAULT 0,
  `custom_services` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `product_change_logs`
--
...
--
-- Table structure for table `product_comment_reports`
--

CREATE TABLE `product_comment_reports` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `product_comment_reply_id` bigint(20) UNSIGNED NOT NULL,
...
CREATE TABLE `product_discounts` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `product_id` bigint(20) UNSIGNED NOT NULL,
  `regular_percentage` int(10) UNSIGNED NOT NULL,
  `regular_price` double NOT NULL,
  `extended_percentage` int(10) UNSIGNED DEFAULT NULL,
...
--
-- Table structure for table `product_report_settings`
--

CREATE TABLE `product_report_settings` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `auto_restrict` tinyint(1) NOT NULL DEFAULT 1,
  `restrict_threshold` int(11) NOT NULL DEFAULT 10,
  `restrict_days` int(11) NOT NULL DEFAULT 7,
  `auto_delete` tinyint(1) NOT NULL DEFAULT 0,
  `delete_threshold` int(11) NOT NULL DEFAULT 20,
  `restrict_reporter` tinyint(1) NOT NULL DEFAULT 0,
  `reporter_days` int(11) NOT NULL DEFAULT 7,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `levels` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
  `min_earnings` bigint(20) UNSIGNED NOT NULL,
...
(7, 'buyer_product_update', 'Buyer product Update', 'New Update ({{product_name}})', '<h2>Hi, {{buyer_username}}!</h2><p>The seller <strong>{{seller_username}} </strong>has released a new update for <strong>{{product_name}}, </strong>here is the details:</p><p><a href=\"{{product_link}}\"><strong>{{product_name}}</strong></a></p><p><a href=\"{{product_link}}\">{{product_preview_image}}</a></p><p><strong>View product:</strong> <a href=\"{{product_link}}\">{{product_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"buyer_username\",\"seller_username\",\"product_name\",\"product_preview_image\",\"product_link\",\"website_name\"]', 1),
(8, 'follower_new_product', 'Follower New product', '{{seller_username}} has published a new product', '<h2>Hi, {{follower_username}}!</h2><p>The seller <strong>{{seller_username}} </strong>has published a new product, here is the details:</p><p><a href=\"{{product_link}}\"><strong>{{product_name}}</strong></a></p><p><a href=\"{{product_link}}\">{{product_preview_image}}</a></p><p><strong>View product:</strong> <a href=\"{{product_link}}\">{{product_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"follower_username\",\"seller_username\",\"product_name\",\"product_preview_image\",\"product_link\",\"website_name\"]', 1),
...
(10, 'purchase_confirmation', 'Purchase Confirmation', 'Your Purchase Confirmation ({{product_name}})', '<h2>Hi, {{username}}</h2><p>We are thrilled to inform you that your recent purchase has been successfully processed. Your satisfaction is our priority, and we are grateful for your trust in {{website_name}}.</p><p><strong><u>Here are the details of your purchase:</u></strong></p><p><a href=\"{{product_link}}\">{{product_preview_image}}</a></p><p><strong>product Name: </strong><a href=\"{{product_link}}\">{{product_name}}</a></p><p><strong>Purchase Code: </strong>{{purchase_code}}</p><p><strong>Download Link: </strong><a href=\"{{download_link}}\">{{download_link}}</a></p><p>If you have any questions or require further assistance, please don\'t hesitate to contact us. We are here to help.</p><p>Best regards,<br><strong>{{website_name}}</strong></p>', '[\"username\",\"product_name\",\"product_preview_image\",\"product_link\",\"purchase_code\",\"download_link\",\"website_name\"]', 1),
...
(12, 'product_comment_reply', 'product Comment Reply', '{{seller_username}} Replied to your comment on \"{{product_name}}\"', '<h2>Hi, {{user_username}}</h2><p>The seller <strong>{{seller_username}}</strong> replied to your comment on “<a href=\"{{product_link}}\">{{product_name}}</a>”</p><p>--</p><p><i>{{comment_reply}}</i></p><p>--</p><p><span style=\"background-color:rgb(255,255,255);color:rgb(34,34,34);\">You can reply by following this link</span><strong>:</strong> <a href=\"{{comment_link}}\">{{comment_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"user_username\",\"seller_username\",\"comment_reply\",\"product_name\",\"product_link\",\"comment_link\",\"website_name\"]', 1),
(13, 'refund_request_new_reply', 'Refund Request New Reply', 'New reply on your refund request for \"{{refund_product_name}}\"', '<h2>Hi, {{user_username}}</h2><p>You have a new reply on your refund request for “<strong>{{refund_product_name}}</strong>” from <strong>{{seller_username}}&nbsp;</strong></p><p>--</p><p><i>{{refund_reply}}</i></p><p>--</p><p><span style=\"background-color:rgb(255,255,255);color:rgb(34,34,34);\">You can view and reply by following this link</span><strong>:</strong> <a href=\"{{refund_link}}\">{{refund_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"user_username\",\"seller_username\",\"refund_id\",\"refund_product_name\",\"refund_reply\",\"refund_link\",\"website_name\"]', 1),
(14, 'refund_request_accepted', 'Refund Request Accepted', 'Your refund request for \"{{refund_product_name}}\" has been accepted', '<h2>Hi, {{user_username}}</h2><p>Your refund request for “<strong>{{refund_product_name}}</strong>” has been accepted by <strong>{{seller_username}}</strong> and the full amount of <strong>{{refund_amount}}</strong> has been refunded to your {{website_name}} account.</p><p><span style=\"background-color:rgb(255,255,255);color:rgb(34,34,34);\">You can view the refund request by following this link</span><strong>:</strong> <a href=\"{{refund_link}}\">{{refund_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"user_username\",\"seller_username\",\"refund_id\",\"refund_product_name\",\"refund_amount\",\"refund_link\",\"website_name\"]', 1),
(15, 'refund_request_declined', 'Refund Request Declined', 'Your refund request for \"{{refund_product_name}}\" has declined by {{seller_username}}', '<h2>Hi, {{user_username}}</h2><p>Your refund request for “<strong>{{refund_product_name}}</strong>” has declined by <strong>{{seller_username}}&nbsp;</strong></p><p>--</p><p><i>{{refund_decline_reason}}</i></p><p>--</p><p><span style=\"background-color:rgb(255,255,255);color:rgb(34,34,34);\">You can view the refund request by following this link</span><strong>:</strong> <a href=\"{{refund_link}}\">{{refund_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"user_username\",\"seller_username\",\"refund_id\",\"refund_product_name\",\"refund_decline_reason\",\"refund_link\",\"website_name\"]', 1),
(16, 'seller_product_soft_rejected', 'Seller product Soft Rejected', '[Soft Rejected] {{product_name}}', '<h2>Hi, {{seller_username}}!</h2><p>Your product <strong>{{product_name}}</strong> needs improvements, check the rejection reason edit your product, and resubmit it.</p><p><strong><u>product Details:</u></strong></p><p>{{product_preview_image}}</p><p><strong>product ID:</strong> #{{product_id}}</p><p><strong>product Name: </strong>{{product_name}}</p><p><strong>product Edit Link:</strong><a href=\"{{review_link}}\"> </a><a href=\"{{product_edit_link}}\">{{product_edit_link}}</a></p><p><strong><u>Rejection Reason:</u></strong></p><p>--</p><p><i>{{rejection_reason}}</i></p><p><i>--</i></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"product_id\",\"product_name\",\"product_preview_image\",\"product_edit_link\",\"rejection_reason\",\"website_name\"]', 1),
(17, 'seller_product_approved', 'Seller product Approved', 'Your product has been Approved', '<h2>Hi, {{seller_username}}!</h2><p>Your product has been approved and it\'s available for purchase.</p><p><a href=\"{{product_link}}\"><strong>{{product_name}}</strong></a></p><p><a href=\"{{product_link}}\">{{product_preview_image}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"product_name\",\"product_preview_image\",\"product_link\",\"website_name\"]', 1),
(18, 'seller_product_hard_rejected', 'Seller product Hard Rejected', '[Hard Rejected] {{product_name}}', '<h2>Hi, {{seller_username}}!</h2><p>Your product has been rejected because it does not meet our site standards.</p><p><strong>{{product_name}}</strong></p><p>{{product_preview_image}}</p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"product_name\",\"product_preview_image\",\"website_name\"]', 1),
(19, 'seller_product_update_approved', 'Seller product Update Approved', 'Your product update has been Approved', '<h2>Hi, {{seller_username}}!</h2><p>Your product update has been approved.</p><p><a href=\"{{product_link}}\"><strong>{{product_name}}</strong></a></p><p><a href=\"{{product_link}}\">{{product_preview_image}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"product_name\",\"product_preview_image\",\"product_link\",\"website_name\"]', 1),
(20, 'seller_product_update_rejected', 'Seller product Update Rejected', '[Update Rejected] {{product_name}}', '<h2>Hi, {{seller_username}}!</h2><p>Your product update has been rejected for the following reasons:</p><p>--</p><p><i>{{rejection_reason}}</i></p><p><i>--</i></p><p><a href=\"{{product_link}}\"><strong>{{product_name}}</strong></a></p><p><a href=\"{{product_link}}\">{{product_preview_image}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"product_name\",\"product_preview_image\",\"product_link\",\"rejection_reason\",\"website_name\"]', 1),
(21, 'seller_product_review', 'Seller product Review ', 'New review on your product \"{{product_name}}\" from {{user_username}}', '<h2>Hi, {{seller_username}}</h2><p>You have a new review on your product “<a href=\"{{product_link}}\">{{product_name}}</a>” from {{user_username}}</p><p><strong>Stars:</strong> {{stars}}</p><p><strong>Subject:</strong> {{subject}}</p><p>--</p><p><i>{{review}}</i></p><p>--</p><p>Review link: <a href=\"{{review_link}}\">{{review_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"user_username\",\"stars\",\"subject\",\"review\",\"product_name\",\"product_link\",\"review_link\",\"website_name\"]', 1),
(22, 'seller_product_comment', 'Seller product Comment ', 'New comment on your product \"{{product_name}}\" from {{user_username}}', '<h2>Hi, {{seller_username}}</h2><p>You have a new comment on your product “<a href=\"{{product_link}}\">{{product_name}}</a>” from {{user_username}}</p><p>--</p><p><i>{{comment}}</i></p><p>--</p><p><span style=\"background-color:rgb(255,255,255);color:rgb(34,34,34);\">You can reply by following this link</span><strong>:</strong> <a href=\"{{comment_link}}\">{{comment_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"user_username\",\"comment\",\"product_name\",\"product_link\",\"comment_link\",\"website_name\"]', 1),
(23, 'seller_product_comment_reply', 'Seller product Comment Reply', 'New comment reply on your product \"{{product_name}}\" from {{user_username}}', '<h2>Hi, {{seller_username}}</h2><p>You have a new comment reply on your product “<a href=\"{{product_link}}\">{{product_name}}</a>” from {{user_username}}</p><p>--</p><p><i>{{comment_reply}}</i></p><p>--</p><p><span style=\"background-color:rgb(255,255,255);color:rgb(34,34,34);\">You can reply by following this link</span><strong>:</strong> <a href=\"{{comment_link}}\">{{comment_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"user_username\",\"comment_reply\",\"product_name\",\"product_link\",\"comment_link\",\"website_name\"]', 1),
(24, 'seller_withdrawal_status_updated', 'Seller Withdrawal Status Updated', 'Your withdrawal status has been updated', '<h2>Hi, <strong>{{seller_username}}</strong></h2><p>The status of your withdrawal request has been updated</p><p><strong><u>Withdrawal details:</u></strong></p><p><strong>Request ID: </strong>#{{request_id}}</p><p><strong>Amount : </strong>{{amount}}</p><p><strong>Method : </strong>{{method}}</p><p><strong>Account : </strong>{{account}}</p><p><strong>Status : </strong>{{status}}</p><p><strong>Date</strong>: {{date}}</p><p><strong>Link:</strong> <a href=\"{{link}}\">{{link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"request_id\",\"amount\",\"method\",\"account\",\"status\",\"date\",\"link\",\"website_name\"]', 1),
(25, 'seller_new_refund_request', 'Seller New Refund Request', 'Refund Request for \"{{refund_product_name}}\" from {{user_username}}', '<h2>Hi, {{seller_username}}</h2><p>You have a new refund request for “<strong>{{refund_product_name}}</strong>” from <strong>{{user_username}}</strong></p><p>--</p><p><i>{{refund_reason}}</i></p><p>--</p><p><span style=\"background-color:rgb(255,255,255);color:rgb(34,34,34);\">You can view and take action by following this link</span><strong>:</strong> <a href=\"{{refund_link}}\">{{refund_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"user_username\",\"refund_id\",\"refund_product_name\",\"refund_reason\",\"refund_link\",\"website_name\"]', 1),
(26, 'seller_refund_request_new_reply', 'Seller Refund Request New Reply', 'New Reply On Refund request [#{{refund_id}}]', '<h2>Hi, {{seller_username}}</h2><p>You have a new reply on refund request for “<strong>{{refund_product_name}}</strong>” from <strong>{{user_username}}&nbsp;</strong></p><p>--</p><p><i>{{refund_reply}}</i></p><p>--</p><p><span style=\"background-color:rgb(255,255,255);color:rgb(34,34,34);\">You can view and take action by following this link</span><strong>:</strong> <a href=\"{{refund_link}}\">{{refund_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"user_username\",\"refund_id\",\"refund_product_name\",\"refund_reply\",\"refund_link\",\"website_name\"]', 1),
(27, 'editor_product_pending', 'Editor product Pending', 'New Pending product ({{product_name}})', '<h2>Hello!</h2><p>The seller <strong>{{seller_username}}</strong> has submitted a new product, please review it and take necessary action.</p><p><strong><u>Here is the details:</u></strong></p><p>{{product_preview_image}}</p><p><strong>product ID:</strong> #{{product_id}}</p><p><strong>product Name: </strong>{{product_name}}</p><p><strong>Review Link:</strong> <a href=\"{{review_link}}\">{{review_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"product_id\",\"product_name\",\"product_preview_image\",\"review_link\",\"website_name\"]', 1),
(28, 'editor_product_resubmitted', 'Editor product Resubmitted', 'product Resubmitted ({{product_name}})', '<h2>Hello!</h2><p>The seller <strong>{{seller_username}}</strong> has resubmitted the product <strong>{{product_name}}</strong>, please review it and take necessary action.</p><p><strong><u>Here is the details:</u></strong></p><p>{{product_preview_image}}</p><p><strong>product ID:</strong> #{{product_id}}</p><p><strong>product Name: </strong>{{product_name}}</p><p><strong>Review Link:</strong> <a href=\"{{review_link}}\">{{review_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"product_id\",\"product_name\",\"product_preview_image\",\"review_link\",\"website_name\"]', 1),
(29, 'editor_product_update', 'Editor product Update', 'product Update Request ({{product_name}})', '<h2>Hello!</h2><p>The seller <strong>{{seller_username}}</strong> submitted an updating request for product <strong>{{product_name}}</strong>, please review it and take necessary action.</p><p><strong><u>Here is the details:</u></strong></p><p>{{product_preview_image}}</p><p><strong>product ID:</strong> #{{product_id}}</p><p><strong>product Name: </strong>{{product_name}}</p><p><strong>Review Link:</strong><a href=\"{{review_link}}\"> {{review_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"product_id\",\"product_name\",\"product_preview_image\",\"review_link\",\"website_name\"]', 1),
(30, 'admin_id_verification_pending', 'Admin ID Verification Pending', 'ID Verification Request [#{{id_verification_id}}]', '<h2>Hello!</h2><p>You have a new ID Verification Request submitted by <strong>{{username}} </strong>and the ID is #<strong>{{id_verification_id}}</strong></p><p><a href=\"{{review_link}}\">{{review_link}}</a></p><p>Best regards,<br><strong>{{website_name}}</strong></p>', '[\"username\",\"id_verification_id\",\"review_link\",\"website_name\"]', 1),
(31, 'admin_product_pending', 'Admin product Pending', 'New Pending product ({{product_name}})', '<h2>Hello!</h2><p>The seller <strong>{{seller_username}}</strong> has submitted a new product and its waiting for review.</p><p><strong><u>Here is the details:</u></strong></p><p>{{product_preview_image}}</p><p><strong>product ID:</strong> #{{product_id}}</p><p><strong>product Name: </strong>{{product_name}}</p><p><strong>Review Link:</strong> <a href=\"{{review_link}}\">{{review_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"product_id\",\"product_name\",\"product_preview_image\",\"review_link\",\"website_name\"]', 1),
(32, 'admin_product_resubmitted', 'Admin product Resubmitted', 'product Resubmitted ({{product_name}})', '<h2>Hello!</h2><p>The seller <strong>{{seller_username}}</strong> has resubmitted the product <strong>{{product_name}} </strong>and it is waiting for review.</p><p><strong><u>Here is the details:</u></strong></p><p>{{product_preview_image}}</p><p><strong>product ID:</strong> #{{product_id}}</p><p><strong>product Name: </strong>{{product_name}}</p><p><strong>Review Link:</strong> <a href=\"{{review_link}}\">{{review_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"product_id\",\"product_name\",\"product_preview_image\",\"review_link\",\"website_name\"]', 1),
(33, 'admin_product_update', 'Admin product Update', 'product Update Request ({{product_name}})', '<h2>Hello!</h2><p>The seller <strong>{{seller_username}}</strong> request updating the product <strong>{{product_name}}.</strong></p><p><strong><u>Here is the details:</u></strong></p><p>{{product_preview_image}}</p><p><strong>product ID:</strong> #{{product_id}}</p><p><strong>product Name: </strong>{{product_name}}</p><p><strong>Review Link:</strong> <a href=\"{{review_link}}\">{{review_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"product_id\",\"product_name\",\"product_preview_image\",\"review_link\",\"website_name\"]', 1),
...
(35, 'admin_withdrawal_pending', 'Admin Withdrawal Pending', 'New Withdrawal Request [#{{request_id}}]', '<h2>Hello!</h2><p>The seller <strong>{{seller_username}} </strong>has requested a new withdrawal.</p><p><strong><u>Withdrawal details:</u></strong></p><p><strong>Request ID: </strong>#{{request_id}}</p><p><strong>Amount : </strong>{{amount}}</p><p><strong>Method : </strong>{{method}}</p><p><strong>Account : </strong>{{account}}</p><p><strong>Status : </strong>{{status}}</p><p><strong>Date</strong>: {{date}}</p><p><strong>Review Link:</strong> <a href=\"{{review_link}}\">{{review_link}}</a></p><p>Regards,&nbsp;<br><strong>{{website_name}}</strong></p>', '[\"seller_username\",\"request_id\",\"amount\",\"method\",\"account\",\"status\",\"date\",\"review_link\",\"website_name\"]', 1),
...
--
-- Table structure for table `chatbox_block_models`
--

CREATE TABLE `chatbox_block_models` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `chatbox_chats`
--

CREATE TABLE `chatbox_chats` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
CREATE TABLE `chatbox` (
  ...
  `user_one_deleted_at` timestamp NULL DEFAULT NULL,
  `user_two_deleted_at` timestamp NULL DEFAULT NULL,
...
--
-- Table structure for table `chatbox_settings`
--

CREATE TABLE `chatbox_settings` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `chatbox_system_enabled` tinyint(1) NOT NULL DEFAULT 1,
  `banned_keywords` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`banned_keywords`)),
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(50, '2014_10_13_000000_create_editors_table', 47),
(51, '2014_10_13_100000_create_editor_password_resets_table', 47),
...
(59, '2023_12_10_172652_create_top_nav_menus_table', 53),
(60, '2023_12_10_172707_create_bottom_nav_menus_table', 53),
(61, '2023_12_10_172728_create_footer_menus_table', 53),
...
(65, '2023_12_16_181029_create_category_editor_table', 54),
...
(81, '2024_01_03_003738_create_products_table', 57),
(83, '2024_01_06_014922_create_user_badges_table', 57),
(84, '2024_02_18_165133_create_withdrawals_table', 57),
(85, '2024_02_24_162334_create_id_verifications_table', 57),
(89, '2014_10_11_000000_create_admins_table', 58),
(90, '2014_10_11_100000_create_admin_password_resets', 58),
(91, '2024_01_05_165601_create_product_histories_table', 58),
(92, '2024_03_02_194241_create_product_updates_table', 58),
(93, '2024_03_09_193935_create_product_discounts_table', 59),
(95, '2024_03_13_165718_create_home_sections_table', 60),
(100, '2024_03_19_171106_create_cart_products_table', 62),
(120, '2024_04_01_235823_create_product_reviews_table', 65),
(123, '2024_04_04_223313_create_product_comments_table', 66),
(124, '2024_04_04_223335_create_product_comment_replies_table', 66),
...
(157, '2024_04_04_223335_create_product_views_table', 82),
(158, '2024_04_01_235824_create_product_review_replies_table', 83),
...
(170, '2024_06_21_191033_create_product_change_logs_table', 87),
...
(177, '2024_03_21_050420_create_transaction_products_table', 91),
(182, '2024_07_10_105956_create_support_earnings_table', 92),
(183, '2024_08_24_114518_create_product_comment_reports_table', 93),
...
(195, '2025_06_03_201506_add_custom_fields_to_top_nav_menus_table', 100),
(196, '2025_06_18_215439_add_custom_fields_to_bottom_nav_menus_table', 100),
(197, '2025_07_11_145036_add_dimensions_to_uploaded_files_table', 100),
(198, '2025_07_17_215657_create_product_drafts_table', 100),
(199, '2025_07_20_190609_add_new_fields_to_products_table', 100),
(200, '2025_07_20_190719_add_new_fields_to_product_updates_table', 100),
(201, '2025_08_06_204015_create_notification_preferences_table', 100),
(202, '2025_08_06_205014_user_notifications', 101),
(203, '2025_08_20_000041_add_restriction_columns_to_products_table', 101),
(204, '2025_08_20_221024_product_reports', 102),
(205, '2025_08_21_182036_recreate_product_report_settings_table', 102),
(206, '2025_08_22_115540_create_chatbox_table', 102),
(207, '2025_08_22_151533_create_chatbox_settings_table', 102),
(208, '2025_08_22_174311_add_activity_columns_to_users_table', 102),
(209, '2025_08_29_200428_create_feedback_table', 102);
...
(9, 'Free products Policy', 'free-products-policy', '<p><strong>What is Lorem Ipsum?</strong></p><p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p><p><strong>Where does it come from?</strong></p><p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of \"de Finibus Bonorum et Malorum\" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, \"Lorem ipsum dolor sit amet..\", comes from a line in section 1.10.32.</p><p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from \"de Finibus Bonorum et Malorum\" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.</p><p><strong>Why do we use it?</strong></p><p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p><p><strong>Where can I get some?</strong></p><p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don\'t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn\'t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry', 5, '2024-06-01 13:39:34', '2024-12-04 18:54:22'),
...
CREATE TABLE `payment_gateways` (
  ...
  `charge_currency` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `plans` (Membership Packages)
--
...
CREATE TABLE `plans` (
  ...
  `downloads` bigint(20) UNSIGNED DEFAULT NULL,
...
--
-- Table structure for table `premium_earnings` (Membership Earnings)
--

CREATE TABLE `premium_earnings` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `seller_id` bigint(20) UNSIGNED NOT NULL,
  `premium_id` bigint(20) UNSIGNED DEFAULT NULL,
...
--
-- Table structure for table `editor_password_resets`
--

CREATE TABLE `editor_password_resets` (
  `email` varchar(255) NOT NULL,
  `token` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sales` (
  ...
  `buyer_tax` text DEFAULT NULL,
  `author_fee` double DEFAULT 0,
  `author_tax` text DEFAULT NULL,
...
(1, 'general', '{\"site_name\":\"Test\",\"site_url\":\"https:\\/\\/tools.diziplace.com\",\"date_format\":\"10\",\"timezone\":\"America\\/New_York\",\"contact_email\":null}'),
...
(3, 'actions', '{\"registration\":1,\"email_verification\":0,\"become_a_seller\":1,\"api\":1,\"gdpr_cookie\":1,\"force_ssl\":0,\"blog\":1,\"tickets\":1,\"refunds\":1,\"contact_page\":0}'),
...
(8, 'system_editor', '{\"colors\":{\"primary_color\":\"#4caf50\",\"secondary_color\":\"#222222\",\"background_color\":\"#f9fafb\",\"sidebar_background_color\":\"#222222\",\"navbar_background_color\":\"#ffffff\"}}'),
(9, 'id_verification', '{\"status\":1,\"photo_verification\":1,\"required\":0,\"id_front_image\":\"images\\/id-documents\\/F6uxReOavrBbRnr_1708719956.svg\",\"id_back_image\":\"images\\/id-documents\\/lDNgqlaFCClbRaA_1708720002.svg\",\"passport_image\":\"images\\/id-documents\\/QLEDc8sXn6h2e7E_1708729601.svg\",\"selfie_image\":\"images\\/id-documents\\/5CwgvmI9gcd067i_1708720379.svg\"}'),
(10, 'product', '{\"maximum_tags\":\"15\",\"minimum_price\":\"1.00\",\"maximum_price\":\"5000.00\",\"buy_now_button\":1,\"free_product_option\":1,\"free_product_total_downloads\":1,\"free_products_require_login\":1,\"external_file_link_option\":1,\"reviews_status\":1,\"comments_status\":1,\"changelogs_status\":1,\"support_status\":1,\"discount_status\":1,\"discount_max_percentage\":\"70\",\"discount_max_days\":\"20\",\"discount_tb\":\"30\",\"discount_tb_pch\":\"30\",\"trending_number\":\"20\",\"best_selling_number\":\"20\",\"max_files\":\"12\",\"max_file_size\":314572800,\"convert_images_webp\":\"1\",\"file_duration\":\"24\",\"adding_require_review\":1,\"updating_require_review\":0}'),
...
(14, 'links', '{\"terms_of_use_link\":\"\\/terms-of-use\",\"seller_terms_link\":\"\/seller-terms\",\"referral_terms_link\":\"\\/referral-program-terms\",\"licenses_terms_link\":\"\\/licenses-terms\",\"free_products_policy_link\":\"\\/free-products-policy\",\"gdpr_cookie_policy_link\":\"\\/gdpr-policy\"}'),
...
(16, 'home_page', '{\"trending_products_refresh\":\"24\",\"best_selling_products_refresh\":\"168\",\"sale_products_refresh\":\"24\",\"latest_products_refresh\":\"1\"}'),
...
(21, 'membership', '{\"status\":1,\"terms_link\":\"\\/membership-terms\"}');
...
(21, 'Android', 'android', NULL, NULL, 5, 16, 21, '2024-03-05 19:54:41', '2025-10-04 07:14:06'),
...
CREATE TABLE `support_earnings` (
  ...
  `author_tax` text DEFAULT NULL,
  `author_earning` double NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1:Active 2:Refunded 3:Cancelled',
...
(1, 'John Carter', 'images/sections/testimonials/GLaTeOUn8DsdOcs_1733598830.jpg', 'Web Developer', 'EasyMarket is a goldmine for web developers like me. The platform\'s extensive collection of PHP scripts and HTML templates has been a lifesaver, saving me time and effort. The quality and variety are unmatched, making EasyMarket my top choice for digital assets.', 0, '2024-03-05 19:35:15', '2024-12-07 13:13:50'),
(2, 'Emma Carter', 'images/sections/testimonials/s1Qvpw5INDTo89B_1733598825.jpg', 'Graphic Designer', 'As a graphic designer, EasyMarket is a dream come true. The marketplace not only showcases my work to a broader audience but also provides a seamless platform for selling graphics. It\'s a go-to place for both buyers and sellers in the creative industry.', 0, '2024-03-05 19:36:15', '2024-12-07 13:13:45'),
(3, 'Amanda Evans', 'images/sections/testimonials/mWN8YLCJBoDNFcT_1733598820.jpg', 'Startup Founder', 'EasyMarket played a pivotal role in our startup journey. We found crucial PHP scripts on the marketplace, significantly speeding up our development process. The reliability and efficiency of EasyMarket have been instrumental in our successful launch.', 0, '2024-03-05 19:36:43', '2024-12-07 13:13:40'),
(4, 'Carlos Martinez', 'images/sections/testimonials/qegCxlxRp2U6T2N_1733598815.jpg', 'E-commerce Entrepreneur', 'EasyMarket is a hidden gem for e-commerce businesses. The platform\'s rich variety of graphics and templates allowed me to enhance my online store\'s visual appeal. EasyMarket is now my first choice for sourcing digital assets for my business.', 0, '2024-03-05 19:37:15', '2024-12-07 13:13:35'),
(5, 'Linda Thompson', 'images/sections/testimonials/OiloYYZTBwP9aQQ_1733598810.jpg', 'Marketing Manager', 'EasyMarket has become an indispensable tool for our marketing team. The marketplace\'s extensive range of templates and scripts empowered us to elevate our online marketing strategies. EasyMarket is a must-have resource for any marketing professional navigating the digital landscape.', 0, '2024-03-05 19:37:54', '2024-12-07 13:13:30');
...
(1, 'Main', 'main', '1.0', 'themes/main/images/preview.jpg', 'Main theme offers a sleek and modern design, prioritizing user-friendly navigation and aesthetics. ', '2023-09-29 22:14:13', '2023-09-29 22:14:17');
...
CREATE TABLE `tickets` (
  ...
  `subject` varchar(255) NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1:Opened 2:Closed',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'My products', 1, 1, '2024-05-06 20:30:10', '2024-05-06 20:36:10'),
...
--
-- Table structure for table `top_nav_menus`
--

CREATE TABLE `top_nav_menus` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
  `link` varchar(255) NOT NULL,
  `link_type` tinyint(1) NOT NULL DEFAULT 1 COMMENT '1:Internal 2:External',
  `parent_id` bigint(20) UNSIGNED DEFAULT NULL,
  `order` bigint(20) NOT NULL DEFAULT 0,
  `custom_classes` varchar(255) DEFAULT NULL,
  `custom_html` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Dumping data for table `top_nav_menus`
--

INSERT INTO `top_nav_menus` (`id`, `name`, `slug`, `menu_type`, `parent_id`, `order`, `custom_classes`, `custom_html`, `created_at`, `updated_at`) VALUES
(1, 'Privacy policy', '/privacy-policy', 1, NULL, 1, NULL, NULL, '2024-03-05 20:15:18', '2024-05-03 21:06:13'),
(2, 'Terms of use', '/terms-of-use', 1, NULL, 3, NULL, NULL, '2024-03-05 20:16:02', '2024-03-17 03:45:17'),
(3, 'Refund Policy', '/refund-policy', 1, NULL, 2, NULL, NULL, '2024-03-05 20:16:09', '2024-03-17 03:44:54'),
(6, 'API Docs', '/public-api', 2, NULL, 4, NULL, NULL, '2024-04-28 19:10:33', '2024-12-03 17:28:19');
...
(13, 'The :attribute field must have between :min and :max products.', 'The :attribute field must have between :min and :max products.', '2024-05-15 20:57:40', '2024-05-15 20:57:40'),
...
(40, 'The :attribute field must have more than :value products.', 'The :attribute field must have more than :value products.', '2024-05-15 20:57:40', '2024-05-15 20:57:40'),
...
(44, 'The :attribute field must have :value products or more.', 'The :attribute field must have :value products or more.', '2024-05-15 20:57:40', '2024-05-15 20:57:40'),
...
(56, 'The :attribute field must have less than :value products.', 'The :attribute field must have less than :value products.', '2024-05-15 20:57:40', '2024-05-15 20:57:40'),
...
(60, 'The :attribute field must not have more than :value products.', 'The :attribute field must not have more than :value products.', '2024-05-15 20:57:40', '2024-05-15 20:57:40'),
...
(65, 'The :attribute field must not have more than :max products.', 'The :attribute field must not have more than :max products.', '2024-05-15 20:57:40', '2024-05-15 20:57:40'),
...
(71, 'The :attribute field must have at least :min products.', 'The :attribute field must have at least :min products.', '2024-05-15 20:57:40', '2024-05-15 20:57:40'),
...
(104, 'The :attribute field must contain :size products.', 'The :attribute field must contain :size products.', '2024-05-15 20:57:41', '2024-05-15 20:57:41'),
...
(586, 'The product has been approved', 'The product has been approved', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(587, 'The product has been soft rejected', 'The product has been soft rejected', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(588, 'The product has been rejected', 'The product has been rejected', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
...
(598, 'The chosen product are not available', 'The chosen product are not available', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(599, 'You cannot purchase your own product', 'You cannot purchase your own product', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(600, 'You have reached the limit for each product', 'You have reached the limit for each product', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(601, 'The product added to cart', 'The product added to cart', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
...
(614, 'All products', 'All products', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(615, ':status products', ':status products', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(616, 'File has been deleted successfully', 'File has been deleted successfully', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(617, 'Your product has been resubmitted successfully', 'Your product has been resubmitted successfully', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(618, 'Your product has been updated successfully', 'Your product has been updated successfully', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
...
(622, '[Cancellation] Purchase #:id (:product_name)', '[Cancellation] Purchase #:id (:product_name)', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(623, '[Cancellation] Sale #:id (:product_name)', '[Cancellation] Sale #:id (:product_name)', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(624, '[Cancellation] Referral Earnings #:id', '[Cancellation] Referral Earnings #:id', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(625, '[Purchase] #:id (:product_name)', '[Purchase] #:id (:product_name)', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(626, '[Sale] #:id (:product_name)', '[Sale] #:id (:product_name)', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(627, '[Referral Earnings] #:id', '[Referral Earnings] #:id', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(628, 'ID Verification Request [#:id]', 'ID Verification Request [#:id]', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(629, 'New Pending Transaction [#:id]', 'New Pending Transaction [#:id]', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(630, '[Refund] Purchase #:id (:product_name)', '[Refund] Purchase #:id (:product_name)', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(631, '[Refund] Sale #:id (:product_name)', '[Refund] Sale #:id (:product_name)', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(632, '[Refund] Referral Earnings #:id', '[Refund] Referral Earnings #:id', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(633, 'product Resubmitted (:product_name)', 'product Resubmitted (:product_name)', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
(634, 'New Pending product (:product_name)', 'New Pending product (:product_name)', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
...
(638, 'product Update Request (:product_name)', 'product Update Request (:product_name)', '2024-05-15 22:26:45', '2024-05-15 22:26:45'),
...
(790, 'Seller Fees', 'Seller Fees', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(794, 'Total products', 'Total products', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(802, 'Top Selling products', 'Top Selling products', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(831, 'editors', 'editors', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
(832, 'Admins', 'Admins', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
(833, 'products', 'products', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
(834, 'Updated products', 'Updated products', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(841, 'ID Verifications', 'ID Verifications', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(849, 'product Settings', 'product Settings', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(852, 'ID Settings', 'ID Settings', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
(853, 'Ticket Settings', 'Ticket Settings', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
(854, 'Seller Levels', 'Seller Levels', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(874, 'Editor Style', 'Editor Style', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(889, 'Seller', 'Seller', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(893, 'product Details', 'product Details', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(901, 'View product', 'View product', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(919, 'This option is to change the status of the product at any time without notifying the user, in case the user wants to restore the product after deleting or allowing the user to update it after hard rejection etc...', 'This option is to change the status of the product at any time without notifying the user, in case the user wants to restore the product after deleting or allowing the user to update it after hard rejection etc...', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
(920, 'Save', 'Save', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
(921, 'Update Review: :product_name', 'Update Review: :product_name', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(924, 'Original product', 'Original product', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(932, 'ID Verification #:id', 'ID Verification #:id', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(963, 'New Editor', 'New Editor', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
(964, 'Login as Editor', 'Login as Editor', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
(965, 'Editor details', 'Editor details', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(968, 'ID Status', 'ID Status', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(995, 'Exclusivity of Seller products', 'Exclusivity of Seller products', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(998, 'The user will be awarded an exclusive seller badge', 'The user will be awarded an exclusive seller badge', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(1001, 'Seller Level', 'Seller Level', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(1016, 'ID Verified', 'ID Verified', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
(1017, 'ID Unverified', 'ID Unverified', '2024-05-15 22:26:46', '2024-05-15 22:26:46'),
...
(1070, 'product', 'product', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
...
(1080, 'Referred By Seller', 'Referred By Seller', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
(1081, 'Seller Earnings', 'Seller Earnings', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
...
(1090, 'Seller Fee', 'Seller Fee', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
(1091, 'Seller Earning', 'Seller Earning', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
...
(1112, 'products Number', 'products Number', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
...
(1117, 'You must clear the cache every time you changed the \"products Number\" or \"Cache Expiry time\"', 'You must clear the cache every time you changed the \"products Number\" or \"Cache Expiry time\"', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
...
(1160, 'Maximum tags that The seller can set for product', 'Maximum tags that The seller can set for product', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
...
(1163, 'Adding the products require review', 'Adding the products require review', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
(1164, 'Updating the products require review', 'Updating the products require review', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
...
(1173, 'Trending products Number', 'Trending products Number', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
(1174, 'Best Selling products Number', 'Best Selling products Number', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
(1175, 'You must setup the cron job to refresh the products every 24 hours.', 'You must setup the cron job to refresh the products every 24 hours.', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
...
(1178, 'Maximum files that can seller upload every time', 'Maximum files that can seller upload every time', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
(1179, 'Maximum File Size', 'Maximum File Size', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
(1180, 'The size of each file The seller can upload', 'The size of each file The seller can upload', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
...
(1190, 'Uploaded files will expire after this time if The seller does not use them.', 'Uploaded files will expire after this time if The seller does not use them.', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
...
(1198, 'When ID Verification is required the user will not be able to buy or sell products until finish the ID Verification.', 'When ID Verification is required the user will not be able to buy or sell products until finish the ID Verification.', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
(1199, 'Photo Verification', 'Photo Verification', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
...
(1212, 'New Seller Level', 'New Seller Level', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
...
(1215, 'Edit Seller Level', 'Edit Seller Level', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
...
(1293, 'Editor Panel Style', 'Editor Panel Style', '2024-05-15 22:26:47', '2024-05-15 22:26:47'),
...
(1324, 'Get All products', 'Get All products', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1325, 'Get An product Details', 'Get An product Details', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1337, 'Navigate to Portal Settings', 'Navigate to Portal Settings', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1338, 'The user should first log in to their account on the platform. Then, they can navigate to the \"Settings\" section of their portal.', 'The user should first log in to their account on the platform. Then, they can navigate to the \"Settings\" section of their portal.', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1339, 'Locate API Key Section', 'Locate API Key Section', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1340, 'Within the Portal Settings, the user should look for a section specifically labeled \"API Key\" or \"API Access.\"', 'Within the Portal Settings, the user should look for a section specifically labeled \"API Key\" or \"API Access.\"', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1349, 'Retrieves all products associated with the provided API key', 'Retrieves all products associated with the provided API key', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1351, 'Retrieves details of a specific product based on the provided product ID and API key.', 'Retrieves details of a specific product based on the provided product ID and API key.', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1352, 'The ID of the product to retrieve', 'The ID of the product to retrieve', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1353, 'product Not Found', 'product Not Found', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1357, '2. Get All products', '2. Get All products', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1358, 'Retrieves all products associated with the provided API key.', 'Retrieves all products associated with the provided API key.', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1359, '3. Get An product Details', '3. Get An product Details', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1365, 'Editor', 'Editor', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1366, 'Updated', 'Updated', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1367, 'product are submitted and waiting review', 'product are submitted and waiting review', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1368, 'product needs improvement by the seller', 'product needs improvement by the seller', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1369, 'product was re-sent after the soft rejection', 'product was re-sent after the soft rejection', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1370, 'product are accepted and available for purchase', 'product are accepted and available for purchase', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1371, 'product are rejected permanently', 'product are rejected permanently', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1372, 'All rights reserved', 'All rights reserved', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1373, 'Seller :username', 'Seller :username', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1402, 'Your cart is currently empty. Start adding products to make your shopping experience complete!', 'Your cart is currently empty. Start adding products to make your shopping experience complete!', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1422, 'Your favorite products', 'Your favorite products', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1423, 'No products found', 'No products found', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1424, 'No products in Favorite', 'No products in Favorite', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1425, 'You do not have any products in favorite. browse and add products you like!', 'You do not have any products in favorite. browse and add products you like!', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1429, 'products Sold', 'products Sold', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1445, ':username\'s products', ':username\'s products', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1446, 'View More', 'View More', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1447, 'Similar products', 'Similar products', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1452, 'This product has no reviews', 'This product has no reviews', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1461, 'This product has no comments', 'This product has no comments', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1462, ':sign_in to comment', ':sign_in to comment', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1463, 'Browse products', 'Browse products', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1468, 'Not products Found', 'Not products Found', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1469, 'There are no products in this section or your search did not return any results', 'There are no products in this section or your search did not return any results', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1487, 'My products', 'My products', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1509, 'Become a Seller', 'Become a Seller', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1510, 'Unleash your creativity and earn by joining our platform as a seller! as a seller, you have the unique opportunity to craft and sell your own products, reaching a wide audience eager to discover new content. Whether you are a developer, designer, or you have any unique products', 'Unleash your creativity and earn by joining our platform as a seller! as a seller, you have the unique opportunity to craft and sell your own products, reaching a wide audience eager to discover new content. Whether you are a developer, designer, or you have any unique products', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1511, 'Upload and sell your products', 'Upload and sell your products', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
(1512, 'Start selling your products today! Our easy upload process allows you to quickly bring your unique products to a global audience.', 'Start selling your products today! Our easy upload process allows you to quickly bring your unique products to a global audience.', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1516, 'Seller terms.', 'Seller terms.', '2024-05-15 22:26:48', '2024-05-15 22:26:48'),
...
(1520, 'New product', 'New product', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
...
(1525, 'Message to the Editor', 'Message to the Editor', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
...
(1536, 'This option is not available for unapproved products', 'This option is not available for unapproved products', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
(1537, 'The price cannot update while the product is on discount', 'The price cannot update while the product is on discount', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
...
(1544, 'product screenshots images (.JPG or .PNG) and maximum :maximum screenshots', 'product screenshots images (.JPG or .PNG) and maximum :maximum screenshots', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
...
(1550, 'You do not have any products', 'You do not have any products', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
(1551, 'You do not have any products, you can start by clicking New product button.', 'You do not have any products, you can start by clicking New product button.', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
(1552, 'ID Verification Pending', 'ID Verification Pending', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
(1553, 'Your ID Verification is currently pending. We are processing your information, and you will be notified once the verification is complete.', 'Your ID Verification is currently pending. We are processing your information, and you will be notified once the verification is complete.', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
(1554, 'ID Verification Required', 'ID Verification Required', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
(1555, 'Your ID Verification is required to continue using our platform. Please complete the verification process as soon as possible.', 'Your ID Verification is required to continue using our platform. Please complete the verification process as soon as possible.', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
(1556, 'Complete ID Verification', 'Complete ID Verification', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
...
(1570, 'When you purchase product, you will be able to see them here.', 'When you purchase product, you will be able to see them here.', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
...
(1573, 'Our referral program offers a great way to earn more income on the platform by just referring people who may purchase products. On each referral you have, you get :percentage% of their purchases.', 'Our referral program offers a great way to earn more income on the platform by just referring people who may purchase products. On each referral you have, you get :percentage% of their purchases.', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
...
(1576, 'Purchased product', 'Purchased product', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
(1577, 'Explain the reason for requesting a refund to the seller, which will help to process your request faster', 'Explain the reason for requesting a refund to the seller, which will help to process your request faster', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
...
(1580, 'Refund: :product_name', 'Refund: :product_name', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
...
(1588, 'ID Verification', 'ID Verification', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
(1589, 'Exclusivity of Your products', 'Exclusivity of Your products', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
(1590, 'You will be awarded an exclusive seller badge', 'You will be awarded an exclusive seller badge', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
(1591, 'ID Verification Completed', 'ID Verification Completed', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
(1592, 'Congratulations! Your ID Verification has been successfully completed. You can now fully access our platform without any restrictions.', 'Congratulations! Your ID Verification has been successfully completed. You can now fully access our platform without any restrictions.', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
...
(1609, 'You do not have any transactions currently, when you purchase new products transactions will show up here', 'You do not have any transactions currently, when you purchase new products transactions will show up here', '2024-05-15 22:26:49', '2024-05-15 22:26:49'),
...
(1642, 'Portal', 'Portal', '2024-05-15 22:28:48', '2024-05-15 22:28:48'),
...
(1646, 'Seller Terms', 'Seller Terms', '2024-05-15 22:34:16', '2024-05-15 22:34:16'),
...
(1655, 'id_verification', 'id_verification', '2024-05-15 22:34:35', '2024-05-15 22:34:35'),
(1656, 'ID Verification Approved', 'ID Verification Approved', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1657, 'ID Verification Rejected', 'ID Verification Rejected', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1658, 'New Ticket Reply', 'New Ticket Reply', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1659, 'Buyer product Update', 'Buyer product Update', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1660, 'Follower New product', 'Follower New product', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
...
(1664, 'product Comment Reply', 'product Comment Reply', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
...
(1668, 'Seller product Soft Rejected', 'Seller product Soft Rejected', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1669, 'Seller product Approved', 'Seller product Approved', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1670, 'Seller product Hard Rejected', 'Seller product Hard Rejected', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1671, 'Seller product Update Approved', 'Seller product Update Approved', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1672, 'Seller product Update Rejected', 'Seller product Update Rejected', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1673, 'Seller product Review ', 'Seller product Review ', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1674, 'Seller product Comment ', 'Seller product Comment ', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1675, 'Seller product Comment Reply', 'Seller product Comment Reply', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1676, 'Seller Withdrawal Status Updated', 'Seller Withdrawal Status Updated', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1677, 'Seller New Refund Request', 'Seller New Refund Request', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1678, 'Seller Refund Request New Reply', 'Seller Refund Request New Reply', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1679, 'Editor product Pending', 'Editor product Pending', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1680, 'Editor product Resubmitted', 'Editor product Resubmitted', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1681, 'Editor product Update', 'Editor product Update', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1682, 'Admin ID Verification Pending', 'Admin ID Verification Pending', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1683, 'Admin product Pending', 'Admin product Pending', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1684, 'Admin product Resubmitted', 'Admin product Resubmitted', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
(1685, 'Admin product Update', 'Admin product Update', '2024-05-15 22:34:38', '2024-05-15 22:34:38'),
...
(1719, 'product Preview Navbar Background', 'product Preview Navbar Background', '2024-05-15 22:34:56', '2024-05-15 22:34:56'),
...
(1725, 'Profile Seller Header background', 'Profile Seller Header background', '2024-05-15 22:34:57', '2024-05-15 22:34:57'),
...
(1773, 'The selected category has products, it cannot be deleted', 'The selected category has products, it cannot be deleted', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
...
(1776, 'The selected sub category has products, it cannot be deleted', 'The selected sub category has products, it cannot be deleted', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
(1777, 'The soft rejection reason is required', 'The soft rejection reason is required', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
(1778, 'product has marked as deleted successfully', 'product has marked as deleted successfully', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
(1779, 'product has permanently deleted successfully', 'product has permanently deleted successfully', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
(1780, 'The rejection reason is required', 'The rejection reason is required', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
(1781, 'ID Verification has been Approved', 'ID Verification has been Approved', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
(1782, 'ID Verification has been Rejected', 'ID Verification has been Rejected', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
...
(1799, 'Max files cannot be less than total screenshots + product preview image + product main files', 'Max files cannot be less than total screenshots + product preview image + product main files', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
...
(1830, 'The cart product has been updated', 'The cart product has been updated', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
...
(1843, 'Congratulations! You are now a seller', 'Congratulations! You are now a seller', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
(1844, 'Your product has been submitted successfully, we will review it as soon as possible.', 'Your product has been submitted successfully, we will review it as soon as possible.', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
(1845, 'Your product has been added successfully.', 'Your product has been added successfully.', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
...
(1857, 'The product has been deleted successfully', 'The product has been deleted successfully', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
(1858, 'You have pending refund request for that product already', 'You have pending refund request for that product already', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
...
(1872, 'Please complete the ID Verification', 'Please complete the ID Verification', '2024-05-15 22:48:16', '2024-05-15 22:48:16'),
...
(1891, 'product Page (Top)', 'product Page (Top)', '2024-05-16 21:39:19', '2024-05-16 21:39:19'),
(1892, 'product Page (Center)', 'product Page (Center)', '2024-05-16 21:39:19', '2024-05-16 21:39:19'),
(1893, 'product Page (Bottom)', 'product Page (Bottom)', '2024-05-16 21:39:19', '2024-05-16 21:39:19'),
...
(1955, 'Seller Taxes', 'Seller Taxes', '2024-05-30 15:39:49', '2024-05-30 15:39:49'),
...
(1958, 'Edit Seller Tax', 'Edit Seller Tax', '2024-05-30 16:06:20', '2024-05-30 16:06:20'),
...
(1961, 'New Seller Tax', 'New Seller Tax', '2024-05-30 18:38:14', '2024-05-30 18:38:14'),
...
(1973, '[:tax_name (:tax_rate%)] Purchase #:id (:product_name)', '[:tax_name (:tax_rate%)] Purchase #:id (:product_name)', '2024-05-31 20:05:49', '2024-05-31 20:05:49');
INSERT INTO `translates` (`id`, `key`, `value`, `created_at`, `updated_at`) VALUES
(1974, '[:tax_name (:tax_rate%)] Sale #:id (:product_name)', '[:tax_name (:tax_rate%)] Sale #:id (:product_name)', '2024-05-31 20:05:49', '2024-05-31 20:05:49'),
(1975, '[Refund] :tax_name (:tax_rate%) Purchase #:id (:product_name)', '[Refund] :tax_name (:tax_rate%) Purchase #:id (:product_name)', '2024-05-31 20:24:06', '2024-05-31 20:24:06'),
(1976, '[Refund] :tax_name (:tax_rate%) Sale #:id (:product_name)', '[Refund] :tax_name (:tax_rate%) Sale #:id (:product_name)', '2024-05-31 20:24:06', '2024-05-31 20:24:06'),
(1977, '[Cancellation] :tax_name (:tax_rate%) Purchase #:id (:product_name)', '[Cancellation] :tax_name (:tax_rate%) Purchase #:id (:product_name)', '2024-05-31 20:58:23', '2024-05-31 20:58:23'),
(1978, '[Cancellation] :tax_name (:tax_rate%) Sale #:id (:product_name)', '[Cancellation] :tax_name (:tax_rate%) Sale #:id (:product_name)', '2024-05-31 20:58:23', '2024-05-31 20:58:23'),
...
(1985, 'Trending product Badge Color', 'Trending product Badge Color', '2024-06-01 13:16:57', '2024-06-01 13:16:57'),
(1986, 'Sale product Badge Color', 'Sale product Badge Color', '2024-06-01 13:16:57', '2024-06-01 13:16:57'),
(1987, 'Free product Badge Color', 'Free product Badge Color', '2024-06-01 13:16:57', '2024-06-01 13:16:57'),
(1988, 'Free', 'Free', '2024-06-01 13:17:25', '2024-06-01 13:17:25'),
(1989, 'Free product', 'Free product', '2024-06-01 13:36:42', '2024-06-01 13:36:42'),
(1990, 'The seller :seller has offered the product for free, you can now download it.', 'The seller :seller has offered the product for free, you can now download it.', '2024-06-01 20:29:15', '2024-06-01 20:29:15'),
(1991, 'Free products policy', 'Free products policy', '2024-06-01 13:38:20', '2024-06-01 13:38:20'),
(1998, 'Free product option', 'Free product option', '2024-06-01 19:45:32', '2024-06-01 19:45:32'),
(1999, 'You can allow downloading your product for free, please note that everyone can download the product directly from the product page without purchasing, please make sure your product has no purchase code verification.', 'You can allow downloading your product for free, please note that everyone can download the product directly from the product page without purchasing, please make sure your product has no purchase code verification.', '2024-06-01 19:47:42', '2024-06-01 19:47:42'),
...
(2022, 'product files that will buyers download (:types).', 'product files that will buyers download (:types).', '2024-06-10 17:25:34', '2024-06-10 17:25:34'),
...
(2032, 'License Certificate for :product_name', 'License Certificate for :product_name', '2024-06-17 16:45:56', '2024-06-17 16:45:56'),
...
(2035, 'Details of the license can be accessed from your portal purchases page.', 'Details of the license can be accessed from your portal purchases page.', '2024-06-17 16:45:56', '2024-06-17 16:45:56'),
(2036, 'Licensor\\'s Seller Username:', 'Licensor\\'s Seller Username:', '2024-06-17 16:45:56', '2024-06-17 16:45:56'),
(2037, 'Licensee:', 'Licensee:', '2024-06-17 16:45:56', '2024-06-17 16:45:56'),
(2038, 'product ID:', 'product ID:', '2024-06-17 16:45:56', '2024-06-17 16:45:56'),
(2039, 'product Name:', 'product Name:', '2024-06-17 16:45:56', '2024-06-17 16:45:56'),
(2040, 'product URL:', 'product URL:', '2024-06-17 16:45:56', '2024-06-17 16:45:56'),
(2041, 'product Purchase Code:', 'product Purchase Code:', '2024-06-17 16:45:56', '2024-06-17 16:45:56'),
...
(2044, 'View All Featured products', 'View All Featured products', '2024-06-19 10:18:37', '2024-06-19 10:18:37'),
...
(2051, 'Featured product', 'Featured product', '2024-06-19 10:41:03', '2024-06-19 10:41:03'),
(2052, 'This product was featured on :website_name', 'This product was featured on :website_name', '2024-06-19 10:41:03', '2024-06-19 10:41:03'),
(2053, 'Show free product total downloads', 'Show free product total downloads', '2024-06-19 12:25:37', '2024-06-19 12:25:37'),
...
(2060, 'Featured Seller', 'Featured Seller', '2024-06-19 12:32:01', '2024-06-19 12:32:01'),
...
(2063, 'product Reviews', 'product Reviews', '2024-06-21 12:23:20', '2024-06-21 12:23:20'),
(2064, 'product Comments', 'product Comments', '2024-06-21 12:23:20', '2024-06-21 12:23:20'),
...
(2070, 'product Changelogs', 'product Changelogs', '2024-06-26 10:24:34', '2024-06-26 10:24:34'),
...
(2118, 'Support Earnings', 'Support Earnings', '2025-10-04 06:42:22', '2025-10-04 06:42:22'),
(2119, 'Authors Support Earnings', 'Authors Support Earnings', '2025-10-04 06:42:22', '2025-10-04 06:42:22'),
(2120, 'Support Earnings Seller fees', 'Support Earnings Seller fees', '2025-10-04 06:42:22', '2025-10-04 06:42:22'),
(2121, 'General Statistics', 'General Statistics', '2025-10-04 06:42:22', '2025-10-04 06:42:22'),
(2122, 'Chatbox', 'Chatbox', '2025-10-04 07:02:03', '2025-10-04 07:02:03'),
(2123, 'Chatbox Settings', 'Chatbox Settings', '2025-10-04 07:02:03', '2025-10-04 07:02:03'),
(2124, 'Chat History', 'Chat History', '2025-10-04 07:02:03', '2025-10-04 07:02:03'),
(2125, 'Reports', 'Reports', '2025-10-04 07:02:03', '2025-10-04 07:02:03'),
(2126, 'product Reports', 'product Reports', '2025-10-04 07:02:03', '2025-10-04 07:02:03'),
(2127, 'Comment Reports', 'Comment Reports', '2025-10-04 07:02:03', '2025-10-04 07:02:03'),
(2128, 'Feedback', 'Feedback', '2025-10-04 07:02:03', '2025-10-04 07:02:03'),
(2129, 'Financial', 'Financial', '2025-10-04 07:02:03', '2025-10-04 07:02:03'),
(2130, 'Storage Settings', 'Storage Settings', '2025-10-04 07:02:03', '2025-10-04 07:02:03'),
(2131, 'Support Periods', 'Support Periods', '2025-10-04 07:02:03', '2025-10-04 07:02:03'),
(2132, 'Editor Images', 'Editor Images', '2025-10-04 07:02:03', '2025-10-04 07:02:03'),
(2133, 'Visit Site', 'Visit Site', '2025-10-04 07:02:03', '2025-10-04 07:02:03'),
(2134, 'Platform Ltd. - All Rights Reserved', 'Platform Ltd. - All Rights Reserved', '2025-10-04 07:02:03', '2025-10-04 07:02:03'),
(2135, 'What are you looking for?', 'What are you looking for?', '2025-10-04 07:02:07', '2025-10-04 07:02:07'),
(2136, 'Join Free', 'Join Free', '2025-10-04 07:02:07', '2025-10-04 07:02:07'),
(2137, 'Add New product', 'Add New product', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2138, 'Choose category', 'Choose category', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2139, 'Select your preferences', 'Select your preferences', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2140, 'Report any bugs or problem', 'Report any bugs or problem', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2141, 'Your name', 'Your name', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2142, 'Your email', 'Your email', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2143, 'Select reason', 'Select reason', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2144, 'Bugs Report', 'Bugs Report', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2145, 'Intellectual Property', 'Intellectual Property', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2146, 'Fake or Unoriginal product', 'Fake or Unoriginal product', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2147, 'Spam or Misleading', 'Spam or Misleading', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2148, 'Policy Violation', 'Policy Violation', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2149, 'Sexual Content', 'Sexual Content', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2150, 'Others', 'Others', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2151, 'Write Details', 'Write Details', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2152, 'Welcome back!', 'Welcome back!', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2153, ' Sign in', ' Sign in', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2154, 'Forgot Password?', 'Forgot Password?', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2155, 'You don\'t have an account?', 'You don\'t have an account?', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2156, 'Create now', 'Create now', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2157, 'Recover Your Password', 'Recover Your Password', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2158, 'Enter your email', 'Enter your email', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2159, 'Send Request', 'Send Request', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2160, 'Got the password?', 'Got the password?', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2161, 'Create a new account', 'Create a new account', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2162, 'Continue With Email', 'Continue With Email', '2025-10-04 07:02:08', '2025-10-04 07:02:08'),
(2163, 'Re-submitted', 'Re-submitted', '2025-10-04 07:02:52', '2025-10-04 07:02:52'),
(2164, 'Restricted', 'Restricted', '2025-10-04 07:02:52', '2025-10-04 07:02:52'),
(2165, 'Support Purchase', 'Support Purchase', '2025-10-04 07:03:12', '2025-10-04 07:03:12'),
(2166, 'Support Extend', 'Support Extend', '2025-10-04 07:03:12', '2025-10-04 07:03:12'),
(2167, 'Deposit', 'Deposit', '2025-10-04 07:03:12', '2025-10-04 07:03:12'),
(2168, 'Reported products', 'Reported products', '2025-10-04 07:03:42', '2025-10-04 07:03:42'),
(2169, 'Search by product name, user, reason...', 'Search by product name, user, reason...', '2025-10-04 07:03:42', '2025-10-04 07:03:42'),
(2170, 'All Status', 'All Status', '2025-10-04 07:03:42', '2025-10-04 07:03:42'),
(2171, 'Reviewed', 'Reviewed', '2025-10-04 07:03:42', '2025-10-04 07:03:42'),
(2172, 'Resolved', 'Resolved', '2025-10-04 07:03:42', '2025-10-04 07:03:42'),
(2173, 'Dismissed', 'Dismissed', '2025-10-04 07:03:42', '2025-10-04 07:03:42'),
(2174, 'Please select at least one report', 'Please select at least one report', '2025-10-04 07:03:42', '2025-10-04 07:03:42'),
(2175, 'Please select an action', 'Please select an action', '2025-10-04 07:03:42', '2025-10-04 07:03:42'),
(2176, 'Are you sure you want to delete selected reports? This action cannot be undone.', 'Are you sure you want to delete selected reports? This action cannot be undone.', '2025-10-04 07:03:42', '2025-10-04 07:03:42'),
(2177, 'View Settings', 'View Settings', '2025-10-04 07:03:43', '2025-10-04 07:03:43'),
(2178, 'Reported product Comments', 'Reported product Comments', '2025-10-04 07:03:45', '2025-10-04 07:03:45'),
(2179, 'Feedback Management', 'Feedback Management', '2025-10-04 07:03:46', '2025-10-04 07:03:46'),
(2180, 'Search by field, description, user...', 'Search by field, description, user...', '2025-10-04 07:03:46', '2025-10-04 07:03:46'),
(2181, 'Under Review', 'Under Review', '2025-10-04 07:03:46', '2025-10-04 07:03:46'),
(2182, 'Custom Classes (optional)', 'Custom Classes (optional)', '2025-10-04 07:03:56', '2025-10-04 07:03:56'),
(2183, 'e.g., btn btn-primary my-class', 'e.g., btn btn-primary my-class', '2025-10-04 07:03:56', '2025-10-04 07:03:56'),
(2184, 'Add space-separated CSS classes to this menu product.', 'Add space-separated CSS classes to this menu product.', '2025-10-04 07:03:56', '2025-10-04 07:03:56'),
(2185, 'Custom HTML (optional)', 'Custom HTML (optional)', '2025-10-04 07:03:56', '2025-10-04 07:03:56'),
(2186, 'e.g., <i class=\\\"fas fa-star\\\"></i>', 'e.g., <i class=\\\"fas fa-star\\\"></i>', '2025-10-04 07:03:56', '2025-10-04 07:03:56'),
(2187, 'Add custom HTML content to this menu product. Use with caution for security.', 'Add custom HTML content to this menu product. Use with caution for security.', '2025-10-04 07:03:56', '2025-10-04 07:03:56'),
(2188, 'Seller terms link', 'Seller terms link', '2025-10-04 07:04:23', '2025-10-04 07:04:23'),
(2189, 'Referral terms link', 'Referral terms link', '2025-10-04 07:04:23', '2025-10-04 07:04:23'),
(2190, 'Free products policy link', 'Free products policy link', '2025-10-04 07:04:23', '2025-10-04 07:04:23'),
(2191, 'Gdpr cookie policy link', 'Gdpr cookie policy link', '2025-10-04 07:04:23', '2025-10-04 07:04:23'),
(2192, 'Your browser does not support the video.', 'Your browser does not support the video.', '2025-10-04 07:09:08', '2025-10-04 07:09:08'),
(2193, 'Largest Digital Products Marketplace', 'Largest Digital Products Marketplace', '2025-10-04 07:09:08', '2025-10-04 07:09:08'),
(2194, '', '', '2025-10-04 07:09:08', '2025-10-04 07:09:08'),
(2195, 'Explore products', 'Explore products', '2025-10-04 07:09:08', '2025-10-04 07:09:08'),
(2196, 'Trusted By:', 'Trusted By:', '2025-10-04 07:09:08', '2025-10-04 07:09:08'),
(2197, 'Explore More', 'Explore More', '2025-10-04 07:09:08', '2025-10-04 07:09:08'),
(2198, 'What Our Customers Say', 'What Our Customers Say', '2025-10-04 07:09:08', '2025-10-04 07:09:08'),
(2199, 'Enter your details to join with us!', 'Enter your details to join with us!', '2025-10-04 07:09:27', '2025-10-04 07:09:27'),
(2200, ' and', ' and', '2025-10-04 07:09:27', '2025-10-04 07:09:27'),
(2201, 'Privacy policy', 'Privacy policy', '2025-10-04 07:09:27', '2025-10-04 07:09:27'),
(2202, 'Create Account', 'Create Account', '2025-10-04 07:09:27', '2025-10-04 07:09:27'),
(2203, 'Already have an account?', 'Already have an account?', '2025-10-04 07:09:27', '2025-10-04 07:09:27'),
(2204, 'Filter Options', 'Filter Options', '2025-10-04 07:14:06', '2025-10-04 07:14:06'),
(2205, 'Price range', 'Price range', '2025-10-04 07:14:06', '2025-10-04 07:14:06'),
(2206, 'stars', 'stars', '2025-10-04 07:14:06', '2025-10-04 07:14:06'),
(2207, 'star', 'star', '2025-10-04 07:14:06', '2025-10-04 07:14:06'),
(2208, 'This is not included for audio products', 'This is not included for audio products', '2025-10-04 07:14:26', '2025-10-04 07:14:26'),
(2209, 'This is only included for video products', 'This is only included for video products', '2025-10-04 07:14:26', '2025-10-04 07:14:26'),
(2210, 'This is only included for audio products', 'This is only included for audio products', '2025-10-04 07:14:26', '2025-10-04 07:14:26'),
(2211, 'This is only included if product has screenshots', 'This is only included if product has screenshots', '2025-10-04 07:14:26', '2025-10-04 07:14:26'),
(2212, 'This will not exist if support is disabled or its not supported', 'This will not exist if support is disabled or its not supported', '2025-10-04 07:14:26', '2025-10-04 07:14:26');
...
CREATE TABLE `users` (
  ...
  `level_id` bigint(20) UNSIGNED DEFAULT NULL,
  `exclusivity` enum('exclusive','non_exclusive') DEFAULT NULL,
  `total_sales` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
  `total_sales_amount` double DEFAULT 0,
  `total_referrals_earnings` double DEFAULT 0,
  `total_reviews` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
  `avg_reviews` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
  `total_followers` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
  `total_following` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
  `avatar` varchar(255) DEFAULT NULL,
  `profile_cover` varchar(255) DEFAULT NULL,
  `profile_heading` varchar(255) DEFAULT NULL,
  `profile_description` longtext DEFAULT NULL,
  `profile_contact_email` varchar(255) DEFAULT NULL,
  `profile_social_links` text DEFAULT NULL,
  ...
  `id_verification_status` tinyint(1) NOT NULL DEFAULT 0,
  `google2fa_status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0: Disabled, 1: Active',
  `google2fa_secret` text DEFAULT NULL,
...
--
-- Indexes for table `bottom_nav_menus`
--
ALTER TABLE `bottom_nav_menus`
  ADD PRIMARY KEY (`id`),
  ADD KEY `bottom_nav_menus_parent_id_foreign` (`parent_id`);
...
ALTER TABLE `cart_products`
  ...
  ADD KEY `cart_products_support_period_id_foreign` (`support_period_id`);
...
--
-- Indexes for table `category_editor`
--
ALTER TABLE `category_editor`
  ADD PRIMARY KEY (`id`),
  ADD KEY `category_editor_category_id_foreign` (`category_id`),
  ADD KEY `category_editor_editor_id_foreign` (`editor_id`);
...
ALTER TABLE `footer_menus`
  ADD PRIMARY KEY (`id`),
  ADD KEY `footer_menus_parent_id_foreign` (`parent_id`);
...
ALTER TABLE `products`
  ...
  ADD KEY `products_ seller_id_foreign` (`seller_id`) USING BTREE;

--
-- Indexes for table `product_change_logs`
--
ALTER TABLE `product_change_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_change_logs_product_id_foreign` (`product_id`);
...
ALTER TABLE `product_comments`
  ...
  ADD KEY `product_comments_seller_id_foreign` (`seller_id`),
...
--
-- Indexes for table `product_comment_reports`
--
ALTER TABLE `product_comment_reports`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_comment_reports_product_comment_reply_id_foreign` (`product_comment_reply_id`),
  ADD KEY `product_comment_reports_user_id_foreign` (`user_id`);
...
ALTER TABLE `product_drafts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_drafts_seller_id_foreign` (`seller_id`),
  ADD KEY `product_drafts_category_id_foreign` (`category_id`);
...
ALTER TABLE `product_histories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_histories_editor_id_foreign` (`editor_id`),
  ADD KEY `product_histories_admin_id_foreign` (`admin_id`),
  ADD KEY `product_histories_product_id_foreign` (`product_id`),
  ADD KEY `product_histories_ seller_id_foreign` (`seller_id`) USING BTREE;
...
ALTER TABLE `product_reports`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_reports_reviewed_by_foreign` (`reviewed_by`),
  ADD KEY `product_reports_product_id_status_index` (`product_id`,`status`),
  ADD KEY `product_reports_user_id_product_id_index` (`user_id`,`product_id`),
  ADD KEY `product_reports_status_index` (`status`),
  ADD KEY `product_reports_created_at_index` (`created_at`);

--
-- Indexes for table `product_report_settings`
--
ALTER TABLE `product_report_settings`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `product_review_replies`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_review_replies_product_review_id_foreign` (`product_review_id`),
  ADD KEY `product_review_replies_user_id_foreign` (`user_id`);
...
ALTER TABLE `product_updates`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `product_updates_name_unique` (`name`),
  ADD KEY `product_updates_product_id_foreign` (`product_id`),
  ADD KEY `product_updates_category_id_foreign` (`category_id`),
  ADD KEY `product_updates_sub_category_id_foreign` (`sub_category_id`),
  ADD KEY `product_updates_ seller_id_foreign` (`seller_id`) USING BTREE;
...
--
-- Indexes for table `chatbox_block_models`
--
ALTER TABLE `chatbox_block_models`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `chatbox_block_models_blocker_id_blocked_id_unique` (`blocker_id`,`blocked_id`),
  ADD KEY `chatbox_block_models_blocked_id_foreign` (`blocked_id`);

--
-- Indexes for table `chatbox_chats`
--
ALTER TABLE `chatbox_chats`
  ADD PRIMARY KEY (`id`),
  ADD KEY `chatbox_chats_sender_id_foreign` (`sender_id`),
  ADD KEY `chatbox_chats_chatbox_id_created_at_index` (`chatbox_id`,`created_at`);
...
ALTER TABLE `chatbox`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `chatbox_user_one_id_user_two_id_unique` (`user_one_id`,`user_two_id`),
  ADD KEY `chatbox_user_two_id_foreign` (`user_two_id`),
  ADD KEY `chatbox_last_message_at_index` (`last_message_at`);
...
ALTER TABLE `notification_preferences`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `notification_preferences_user_id_type_event_unique` (`user_id`,`type`,`event`);
...
ALTER TABLE `premium_earnings`
  ADD PRIMARY KEY (`id`),
  ADD KEY `premium_earnings_seller_id_foreign` (`seller_id`),
  ADD KEY `premium_earnings_premium_id_foreign` (`premium_id`),
  ADD KEY `premium_earnings_product_id_foreign` (`product_id`);
...
ALTER TABLE `referrals`
  ...
  ADD KEY `referrals_seller_id_foreign` (`seller_id`);
...
ALTER TABLE `referral_earnings`
  ...
  ADD KEY `referral_earnings_seller_id_foreign` (`seller_id`),
...
ALTER TABLE `refunds`
  ...
  ADD KEY `refunds_seller_id_foreign` (`seller_id`),
...
ALTER TABLE `editors`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `editors_username_unique` (`username`),
  ADD UNIQUE KEY `editors_email_unique` (`email`);

--
-- Indexes for table `editor_password_resets`
--
ALTER TABLE `editor_password_resets`
  ADD KEY `editor_password_resets_email_index` (`email`);
...
ALTER TABLE `support_earnings`
  ADD PRIMARY KEY (`id`),
  ADD KEY `support_earnings_seller_id_foreign` (`seller_id`),
...
--
-- Indexes for table `top_nav_menus`
--
ALTER TABLE `top_nav_menus`
  ADD PRIMARY KEY (`id`),
  ADD KEY `top_nav_menus_parent_id_foreign` (`parent_id`);
...
ALTER TABLE `transaction_products`
  ADD PRIMARY KEY (`id`),
  ADD KEY `transaction_products_product_id_foreign` (`product_id`),
  ADD KEY `transaction_products_transaction_id_foreign` (`transaction_id`);
...
ALTER TABLE `uploaded_files`
  ADD PRIMARY KEY (`id`),
  ADD KEY `uploaded_files_seller_id_foreign` (`seller_id`) USING BTREE,
...
ALTER TABLE `users`
  ...
  ADD KEY `users_last_active_at_index` (`last_active_at`),
  ADD KEY `users_is_online_index` (`is_online`);
...
ALTER TABLE `withdrawals`
  ADD PRIMARY KEY (`id`),
  ADD KEY `withdrawals_seller_id_foreign` (`seller_id`) USING BTREE;
...
--
-- AUTO_INCREMENT for table `bottom_nav_menus`
--
ALTER TABLE `bottom_nav_menus`
...
--
-- AUTO_INCREMENT for table `category_editor`
--
ALTER TABLE `category_editor`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `product_change_logs`
--
ALTER TABLE `product_change_logs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `product_comment_reports`
--
ALTER TABLE `product_comment_reports`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1000;
...
--
-- AUTO_INCREMENT for table `product_report_settings`
--
ALTER TABLE `product_report_settings`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `chatbox_block_models`
--
ALTER TABLE `chatbox_block_models`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `chatbox_chats`
--
ALTER TABLE `chatbox_chats`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `top_nav_menus`
--
ALTER TABLE `top_nav_menus`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- Constraints for table `bottom_nav_menus`
--
ALTER TABLE `bottom_nav_menus`
  ADD CONSTRAINT `bottom_nav_menus_parent_id_foreign` FOREIGN KEY (`parent_id`) REFERENCES `bottom_nav_menus` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `cart_products`
  ...
  ADD CONSTRAINT `cart_products_support_period_id_foreign` FOREIGN KEY (`support_period_id`) REFERENCES `support_periods` (`id`) ON DELETE SET NULL,
...
--
-- Constraints for table `category_editor`
--
ALTER TABLE `category_editor`
  ADD CONSTRAINT `category_editor_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `category_editor_editor_id_foreign` FOREIGN KEY (`editor_id`) REFERENCES `editors` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `footer_menus`
  ADD CONSTRAINT `footer_menus_parent_id_foreign` FOREIGN KEY (`parent_id`) REFERENCES `footer_links` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `products_user_id_foreign` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `product_change_logs`
--
ALTER TABLE `product_change_logs`
  ADD CONSTRAINT `product_change_logs_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `product_comments`
--
ALTER TABLE `product_comments`
  ADD CONSTRAINT `product_comments_seller_id_foreign` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
...
--
-- Constraints for table `product_comment_reports`
--
ALTER TABLE `product_comment_reports`
  ADD CONSTRAINT `product_comment_reports_product_comment_reply_id_foreign` FOREIGN KEY (`product_comment_reply_id`) REFERENCES `product_comment_replies` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `product_comment_reports_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `product_drafts`
  ADD CONSTRAINT `product_drafts_seller_id_foreign` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `product_drafts_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `product_histories`
--
ALTER TABLE `product_histories`
  ADD CONSTRAINT `product_histories_admin_id_foreign` FOREIGN KEY (`admin_id`) REFERENCES `admins` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `product_histories_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `product_histories_editor_id_foreign` FOREIGN KEY (`editor_id`) REFERENCES `editors` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `product_histories_user_id_foreign` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `product_reports`
  ...
  ADD CONSTRAINT `product_reports_reviewed_by_foreign` FOREIGN KEY (`reviewed_by`) REFERENCES `admins` (`id`) ON DELETE SET NULL,
...
--
ALTER TABLE `product_reviews`
  ADD CONSTRAINT `product_reviews_seller_id_foreign` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `product_review_replies`
  ADD CONSTRAINT `product_review_replies_product_review_id_foreign` FOREIGN KEY (`product_review_id`) REFERENCES `product_reviews` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `product_review_replies_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `product_updates`
--
ALTER TABLE `product_updates`
  ADD CONSTRAINT `product_updates_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `product_updates_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `product_updates_sub_category_id_foreign` FOREIGN KEY (`sub_category_id`) REFERENCES `sub_categories` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `product_updates_user_id_foreign` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `chatbox_block_models`
--
ALTER TABLE `chatbox_block_models`
  ADD CONSTRAINT `chatbox_block_models_blocked_id_foreign` FOREIGN KEY (`blocked_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `chatbox_block_models_blocker_id_foreign` FOREIGN KEY (`blocker_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `chatbox_chats`
--
ALTER TABLE `chatbox_chats`
  ADD CONSTRAINT `chatbox_chats_chatbox_id_foreign` FOREIGN KEY (`chatbox_id`) REFERENCES `chatbox` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `chatbox_chats_sender_id_foreign` FOREIGN KEY (`sender_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `chatbox`
--
ALTER TABLE `chatbox`
  ADD CONSTRAINT `chatbox_user_one_id_foreign` FOREIGN KEY (`user_one_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `chatbox_user_two_id_foreign` FOREIGN KEY (`user_two_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `premium_earnings`
  ADD CONSTRAINT `premium_earnings_seller_id_foreign` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `premium_earnings_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `premium_earnings_premium_id_foreign` FOREIGN KEY (`premium_id`) REFERENCES `subscriptions` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `purchases`
--
ALTER TABLE `purchases`
  ADD CONSTRAINT `purchases_seller_id_foreign` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `referrals`
  ADD CONSTRAINT `referrals_seller_id_foreign` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `referral_earnings`
  ADD CONSTRAINT `referral_earnings_seller_id_foreign` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `refunds`
  ADD CONSTRAINT `refunds_seller_id_foreign` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `support_earnings`
  ADD CONSTRAINT `support_earnings_seller_id_foreign` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
...
--
-- Constraints for table `top_nav_menus`
--
ALTER TABLE `top_nav_menus`
  ADD CONSTRAINT `top_nav_menus_parent_id_foreign` FOREIGN KEY (`parent_id`) REFERENCES `top_nav_menus` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `transaction_products`
  ADD CONSTRAINT `transaction_products_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `transaction_products_transaction_id_foreign` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `uploaded_files`
  ...
  ADD CONSTRAINT `uploaded_files_user_id_foreign` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `withdrawals`
  ADD CONSTRAINT `withdrawals_user_id_foreign` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
