...
class ToastrServiceProvider extends ServiceProvider
{
    ...
    public function registerBladeDirectives()
    {
        ...
        Blade::directive('toastrStyles', function ($version) {
            return "<?php echo app('toastr')->smartStyles($version); ?>";
        });

        // Blade directive for including Toastr scripts
        Blade::directive('toastrScripts', function ($version) {
            return "<?php echo app('toastr')->smartScripts($version); ?>";
        });

        // Blade directive for rendering Toastr notifications
        Blade::directive('toastrRender', function () {
            return "<?php echo app('toastr')->smartRender(); ?>";
        });

        // Blade directive for flushing Laravel default errors and status as Toastr notifications
        Blade::directive('toastrRenderFlush', function () {
            return "<?php echo app('toastr')->smartRenderFlush(); ?>";
        });
    }
}
