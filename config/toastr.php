...
return [
    ...
    'options' => [
        ...
        'closeButtonIcon' => 'codebay-toast-close-icon',
        ...
        'positionClass' => 'codebay-toast-top-right',
        ...
        'icons' => [
            'info' => 'codebay-toast-info-icon',
            'warning' => 'codebay-toast-warning-icon',
            'success' => 'codebay-toast-success-icon',
            'error' => 'codebay-toast-error-icon',
        ],
        ...
        'colorsClasses' => [
            'info' => 'codebay-toast-info',
            'warning' => 'codebay-toast-warning',
            'success' => 'codebay-toast-success',
            'error' => 'codebay-toast-error',
        ],
    ],
